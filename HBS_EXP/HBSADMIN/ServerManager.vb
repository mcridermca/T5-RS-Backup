...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		Dim arr(2) as String 
		arr(0) = "53ADM_Voltage_MasterADM_Voltage_Master"
		arr(1) = "54ADM_Voltage_Master_RowADM_Voltage_Master_Row"
		arr(2) = "59ADM_Voltage_Master_Row_dbInfoADM_Voltage_Master_Row_dbInfo"
	...
	Public Function GetProcesses() As String() Implements RuleStream.IRsApplicationManager.GetProcesses
		Dim arr(0) as String
		arr(0) = "8DefaultProcess5311101DD00000"
		Return arr
	...
	Public Function GetTopLevelParts() As String() Implements RuleStream.IRsApplicationManager.GetTopLevelParts
		Dim arr(0) as String
		arr(0) = "53ADM_Voltage_Master55HBSADMINADM_Voltage_Master"
		Return arr
