...
'$ GenerateDate: 06/12/2025 17:59:26
    ...
    InitPart("ADM_Voltage_Master_Row_dbInfo", <a><![CDATA[ADM_Voltage_Master_Row_dbInfo]]></a>.Value, 59, "HBSADMIN",  "N", "N", False, False, "In Development", "", "DB Info Part Family for PF ADM_Voltage_Master_Row_dbInfo", "", "", "",  "GLOBAL\H601424", "06/12/2025 16:51:59")
    AddProperty("900", "Sort_Order", <a><![CDATA[Sort_Order]]></a>.Value, "First Sort Order 0 = Default = 100 , Adjust Accordingly", "Long","","Master Data","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("901", "Voltage", <a><![CDATA[Voltage]]></a>.Value, "Voltage in Volts AC/ DC (ie. 120 VAC or 200 VDC)", "String","","Master Data","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("910", "Voltage_Master_ID", <a><![CDATA[Voltage_Master_ID]]></a>.Value, "Table Primary Key", "Long","","Master Data PK","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("902", "Created_By", <a><![CDATA[Created_By]]></a>.Value, "User that created the record", "String","","Master DBInfo","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("903", "Created_On", <a><![CDATA[Created_On]]></a>.Value, "Date User Created record", "String","","Master DBInfo","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("908", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master DBInfo","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:59 PM")
    AddProperty("904", "Modified_By", <a><![CDATA[Modified_By]]></a>.Value, "User that modified the record", "String","","Master DBInfo","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("905", "Modified_On", <a><![CDATA[Modified_On]]></a>.Value, "Date modified", "String","","Master DBInfo","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/12/2025 4:51:58 PM")
    AddProperty("897", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/4/2025 6:37:42 PM")
    
      AddDBConstraint(12, "dbSpec", <a><![CDATA[dbSpec]]></a>.Value,"Master DBInfo", 9999)
    ...
    ctx = ContextId
          ...
          InitProperty("Sort_Order", "841", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "First Sort Order 0 = Default = 100 , Adjust Accordingly", "In Development",  0,1408)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Voltage", "842", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "Voltage in Volts AC/ DC (ie. 120 VAC or 200 VDC)", "In Development",  0,1409)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Voltage_Master_ID", "851", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "Table Primary Key", "In Development",  0,1535)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Created_By", "843", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "User that created the record", "In Development",  0,1410)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Created_On", "844", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "Date User Created record", "In Development",  0,1411)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "849", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:59 PM", "Hash of Master Data Fields", "In Development",  0,1527)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Modified_By", "845", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "User that modified the record", "In Development",  0,1412)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Modified_On", "846", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/12/2025 4:51:58 PM", "Date modified", "In Development",  0,1413)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitDBConstraint("dbSpec", 12,"", "Y","", "", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Created_By",12, "Created_By", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Created_On",12, "Created_On", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Modified_By",12, "Modified_By", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Modified_On",12, "Modified_On", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Sort_Order",12, "Sort_Order", "Voltage_Master")
        
          InitDBproperty("dbSpec", "Voltage",12, "Voltage", "Voltage_Master")
