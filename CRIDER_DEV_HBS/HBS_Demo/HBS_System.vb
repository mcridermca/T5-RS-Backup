...
'$ GenerateDate: 03/03/2025 14:37:41
    ...
    InitPart("HBS_System", <a><![CDATA[HBS System]]></a>.Value, 3, "HBS_Demo",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\SVRSDevAdmin", "02/26/2025 11:49:29")
    AddProperty("72", "SpareCapacityForControllers", <a><![CDATA[Spare Capacity for Controllers]]></a>.Value, "The spare capacity of this system for controllers.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 11:38:47 AM")
    AddProperty("70", "SpareCapacityForPSSizing", <a><![CDATA[Spare Capacity for PS Sizing]]></a>.Value, "The spare capacity of this system for PS sizing.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 11:38:06 AM")
    AddProperty("16", "SystemDescription", <a><![CDATA[System Description]]></a>.Value, "A description of the system.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/21/2025 8:28:14 PM")
    AddProperty("15", "SystemName", <a><![CDATA[System Name]]></a>.Value, "The name of the system.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/21/2025 8:27:49 PM")
    AddProperty("17", "TargetHardware", <a><![CDATA[Target Hardware]]></a>.Value, "The target hardware for the system.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/21/2025 8:28:33 PM")
