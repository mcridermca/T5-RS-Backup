...
#Region " IRsApplicationManager Interface Implementation "
	...
	Public Function GetClassAssemblyName(ByVal strName as String) As String Implements RuleStream.IRsApplicationManager.GetClassAssemblyName
		Select Case strName.ToLower
			Case "controller" : Return "HBS_Demo"
			Case "controller_dbdetail" : Return "HBS_Demo"
			Case "device" : Return "HBS_Demo"
			Case "device_dbdetail" : Return "HBS_Demo"
			Case "device_dbdetails" : Return "HBS_Demo"
			Case "hbs_demo_tlp" : Return "HBS_Demo"
			Case "hbs_project" : Return "HBS_Demo"
			Case "hbs_system" : Return "HBS_Demo"
			Case "plant" : Return "HBS_Demo"
			Case "terminal_block" : Return "HBS_Demo"
			Case "terminal_block_terminal" : Return "HBS_Demo"
...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		...
		arr(0) = "6ControllerController"
		arr(1) = "11Controller_DBDetailController_DBDetail"
		arr(2) = "5DeviceDevice"
		arr(3) = "10Device_DBDetailDevice_DBDetail"
		arr(4) = "9Device_DBDetailsDevice_DBDetails"
		arr(5) = "1HBS_Demo_TLPHBS Demo"
		arr(6) = "2HBS_ProjectHBS Project"
		arr(7) = "3HBS_SystemHBS System"
		arr(8) = "4PlantPlant"
		arr(9) = "7Terminal_BlockTerminal Block"
		arr(10) = "8Terminal_Block_TerminalTerminal_Block_Terminal"
	...
	Public Function GetProcesses() As String() Implements RuleStream.IRsApplicationManager.GetProcesses
		Dim arr(0) as String
		arr(0) = "1DefaultProcess111101DD00000"
		Return arr
	...
	Public Function GetTopLevelParts() As String() Implements RuleStream.IRsApplicationManager.GetTopLevelParts
		Dim arr(0) as String
		arr(0) = "1HBS_Demo_TLP52HBS_DemoHBS Demo"
		Return arr
