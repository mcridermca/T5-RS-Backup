...
'$ GenerateDate: 03/03/2025 14:37:41
    ...
    InitPart("Device_DBDetail", <a><![CDATA[Device_DBDetail]]></a>.Value, 10, "HBS_Demo",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\SVRSDevAdmin", "02/28/2025 12:05:36")
    AddProperty("85", "ApplicationUse", <a><![CDATA[Application Use]]></a>.Value, "The application use for the device. Used to filter Device Part Numbers.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("86", "Classification", <a><![CDATA[Classification]]></a>.Value, "The classification of this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("87", "DefaultPartNumber", <a><![CDATA[Default Part Number?]]></a>.Value, "Use the default part number?", "Boolean","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("88", "DefaultQuantity", <a><![CDATA[Default Quantity]]></a>.Value, "The default quantity of this device.", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("89", "DevicePartNumber", <a><![CDATA[Device Part Number]]></a>.Value, "The identifying number or code for the device part.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:47 PM")
    AddProperty("90", "DeviceType", <a><![CDATA[Device Type]]></a>.Value, "The type of device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("92", "Mnemonics", <a><![CDATA[Mnemonics]]></a>.Value, "The mnemonic for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("93", "PartDescription", <a><![CDATA[Part Description]]></a>.Value, "A description of this device part.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("94", "PartShape", <a><![CDATA[Part Shape]]></a>.Value, "The shape of the device part.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("95", "PartType", <a><![CDATA[Part Type]]></a>.Value, "The type of device part. Used to filter the Device Part Numbers.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("96", "PlantName", <a><![CDATA[Plant Name]]></a>.Value, "The name of the plant.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("97", "Point1", <a><![CDATA[Point 1]]></a>.Value, "A point on this Device.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("98", "Point2", <a><![CDATA[Point 2]]></a>.Value, "A point on this Device.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("99", "Point3", <a><![CDATA[Point 3]]></a>.Value, "A point on this Device.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("100", "Point4", <a><![CDATA[Point 4]]></a>.Value, "A point on this Device.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("101", "Point5", <a><![CDATA[Point 5]]></a>.Value, "A point on this Device.", "String","","General","FD", 9999, "", 0,0, "RuleStream", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("102", "PointParameters", <a><![CDATA[Point Parameters]]></a>.Value, "The parameteres for the point for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("103", "PointTerminalBlockLink", <a><![CDATA[Point Terminal Block Link]]></a>.Value, "Terminal block link designations for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("104", "PointType", <a><![CDATA[Point Type]]></a>.Value, "The type of point for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("105", "Pole", <a><![CDATA[Pole]]></a>.Value, "The super-region this device belongs to.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("106", "PowerConsumptionCurrentRating", <a><![CDATA[Power Consumption - Current Rating]]></a>.Value, "The current rating of the power consumption of this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("107", "PowerSupply", <a><![CDATA[Power Supply]]></a>.Value, "The power supply for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("108", "ProcessVariable", <a><![CDATA[Process Variable]]></a>.Value, "A process variable used to filter the Device Part Numbers.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("109", "SignalType", <a><![CDATA[Signal Type]]></a>.Value, "The type of signal used by this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("110", "StandardWiringLegendForPoints", <a><![CDATA[Standard Wiring Legend for Points]]></a>.Value, "The standard wiring legend used for the points of this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("111", "TerminalBlockLabel", <a><![CDATA[Terminal Block Label]]></a>.Value, "The label of a terminal block of this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("112", "TerminalBlockOtherLabel", <a><![CDATA[Terminal Block Other Label]]></a>.Value, "Another label for a terminal block of this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("113", "TerminalBlocks", <a><![CDATA[Terminal Blocks]]></a>.Value, "The number of terminal blocks for this device.", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("114", "WiringType", <a><![CDATA[Wiring Type]]></a>.Value, "The type of wiring for this device.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
    AddProperty("84", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:10 PM")
      ...
      AddPropertyExtended(89,"DevicePartNumber", "79", "EXTLABEL", "Label", "Part Number", "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:47 PM")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("DevicePartNumber", "79", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:47 PM", "", "In Development",  0,164)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Pole", "95", "", "", "Y", "","", 0, "-1", 1, "", "N","0",  "GLOBAL\SVRSDevAdmin", "2/26/2025 7:37:11 PM", "", "In Development",  0,153)
        End If
            If Incontext("-1", ctx) Then
    ...
    ctx = ContextId
        ...
        InitValidValue("Pole_ValidValues", "95", "-1", 154)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitDBConstraint("dbPartsTable", 1,"", "Y","", "", "PartsTable")
        
          InitDBproperty("dbPartsTable", "Classification",1, "Part Classification", "PartsTable")
        
          InitDBproperty("dbPartsTable", "DefaultPartNumber",1, "Default part number", "PartsTable")
        
          InitDBproperty("dbPartsTable", "DefaultQuantity",1, "Default Part Qty", "PartsTable")
        
          InitDBproperty("dbPartsTable", "DeviceType",1, "Type", "PartsTable")
        
          InitDBproperty("dbPartsTable", "Mnemonics",1, "Mnemonics__", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PartDescription",1, "Part Description", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PartShape",1, "Part Shape", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PartType",1, "Part Type", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PointParameters",1, "Point Parameter", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PointTerminalBlockLink",1, "Point  TERMINAL BLOCK Link", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PointType",1, "Point Type", "PartsTable")
        
          InitDBproperty("dbPartsTable", "Pole",1, "Pole", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PowerConsumptionCurrentRating",1, "Power_Cons  umption_Curr  ent_Rating", "PartsTable")
        
          InitDBproperty("dbPartsTable", "PowerSupply",1, "Power Supply", "PartsTable")
        
          InitDBproperty("dbPartsTable", "ProcessVariable",1, "Process  Variable", "PartsTable")
        
          InitDBproperty("dbPartsTable", "SignalType",1, "Signal Type", "PartsTable")
        
          InitDBproperty("dbPartsTable", "StandardWiringLegendForPoints",1, "Std Wiring Legend for  points", "PartsTable")
        
          InitDBproperty("dbPartsTable", "TerminalBlockLabel",1, "TB Label", "PartsTable")
        
          InitDBproperty("dbPartsTable", "TerminalBlocks",1, "No# of TBs", "PartsTable")
        
          InitDBproperty("dbPartsTable", "WiringType",1, "Wiring Type", "PartsTable")
...
'Default to 1
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:95; TYPE:VV
...
'Pulls ValidValues from the highest-level Part (HBS_Projects) that has the property.
      '   END FORMULA; PROP ID:95; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Device_DBDetail.Formula_Pole_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Select Case lngDBConID
        ...
        ctx = this
            ...
            strSelectList = ""
              ...
              strSelectList = strSelectList & leftDelimiter & "Part Classification" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Default part number" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Default Part Qty" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Type" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Mnemonics__" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Part Description" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Part Shape" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Part Type" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Point Parameter" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Point  TERMINAL BLOCK Link" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Point Type" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Pole" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Power_Cons  umption_Curr  ent_Rating" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Power Supply" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Process  Variable" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Signal Type" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Std Wiring Legend for  points" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "TB Label" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "No# of TBs" & rightDelimiter & ", "
            
              strSelectList = strSelectList & leftDelimiter & "Wiring Type" & rightDelimiter & ", "
            ...
            strSelectStmt = BuildSQLStatement(strSelectList, DelimitTableName("PartsTable"), strWhereClause, leftDelimiter & "Part Number" & rightDelimiter, "ASC")
