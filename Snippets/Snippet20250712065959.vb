...
If Me.Is_Scanned Then
	...
	Select Case Me.Panel_ID
		Case "Top"
			...
			If Me.Scan_Angle_Degrees = 45 And FrontScanned And FrontScan_Overhead Then
				Result = 3
			Else
				If Me.Scan_Angle_Degrees = 90 Then
					Result = 1
				Else
					If Me.UsePandAMTBH = False andlso Me.Parent.GapControlMethod = "Passive" Then
						2
					Else
						3
					End If
...
Public [Scanner_Selected] as String
	...
	End Class
End Namespace
'Error #BC30205:End of statement expected. occurred on line#42 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30801:Labels that are numbers must be followed by colons. occurred on line#43 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30801:Labels that are numbers must be followed by colons. occurred on line#45 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30081:'If' must end with a matching 'End If'. occurred on line#59 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30801:Labels that are numbers must be followed by colons. occurred on line#61 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30801:Labels that are numbers must be followed by colons. occurred on line#63 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30072:'Case' can only appear inside a 'Select Case' statement. occurred on line#66 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30072:'Case' can only appear inside a 'Select Case' statement. occurred on line#69 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30072:'Case' can only appear inside a 'Select Case' statement. occurred on line#72 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
...
'Error #BC30451:'FrontScan_Overhead' is not declared. It may be inaccessible due to its protection level. occurred on line#36 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30456:'UsePandAMTBH' is not a member of 'APC_Scan_Panel_Configuration'. occurred on line#42 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC30094:Label '3' is already defined in the current method. occurred on line#61 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=False 
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712065959.vb | iswarning=True 
