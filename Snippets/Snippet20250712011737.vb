...
If Me.Is_Scanned Then
	Select Case Me.SubpartID
		...
		Case 4
		 ...
		 Case 6
			 Result = Me.Parent.Panel_Config_Front(1).
		 Case Else
			 Result = "ERROR!"
	 End Select
...
Public [Scanner_Selected] as String
	...
	End Class
End Namespace
'Error #BC30205:End of statement expected. occurred on line#39 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712011737.vb | iswarning=False 
...
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712011737.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712011737.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712011737.vb | iswarning=True 
