...
If Me.Is_Scanned Then
	...
	Else
		...
		Dim MinGapForScan As Double = Me.Parent.MinGapForScan
		...
		Select Case Me.Product_Spacing_Category 
			...
			Case 2
				...
				Select Case Parent.ShadowingStatus
					Case' "Full"
						'If(BoxSize_Height_Min_IN<BoxSize_Length_Min_IN,MAX(BoxSize_Height_Min_IN,BoxSize_Length_Min_IN,MinGapForScan),BoxSize_Length_Min_IN)
						If
...
Public [Scanner_Selected] as String
	...
	End Class
End Namespace
'Error #BC30201:Expression expected. occurred on line#107 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=False 
'Error #BC30081:'If' must end with a matching 'End If'. occurred on line#109 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=False 
'Error #BC30201:Expression expected. occurred on line#109 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=False 
'Error #BC30071:'Case Else' can only appear inside a 'Select Case' statement. occurred on line#111 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=False 
...
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712085411.vb | iswarning=True 
