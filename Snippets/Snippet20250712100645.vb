...
Dim LeftScanner As Boolean = (Me.Panel_Config_Left(1).Is_Scanned AndAlso Me.Panel_Config_Left(1).Scanner_Selected = "Laser Omni-Directional")
Dim RightScanner As Boolean = (Me.Panel_Config_Right(1).Is_Scanned AndAlso Me.Panel_Config_Right(1).Scanner_Selected = "Laser Omni-Directional")
		End Function
