...
If Me.Is_Scanned Then
	...
	Select Case Me.Panel_ID
		...
		Case "Front"
			...
			' If(And(H93="Overhead",GapControlMethod="Passive",ScanConfigAUsePandAMTBH="No"),2,If(Or(H93="Underside",And(H93="Overhead",Or(GapControlMethod="Active",ScanConfigAUsePandAMTBH="Yes"))),3,If(H93="1 Side",4,5))
			If FrontScanned_Overhead AndAlso Me.Parent.GapControlMethod = "Passive" And Me.Parent.UsePandAMTBH Then
				Result = 2
			Else
				'If(Or(FrontScanned_Underside = True ,And(FrontScanned_Overhead = true,Or(GapControlMethod="Active",ScanConfigAUsePandAMTBH=true))),3,If(FrontScanned_Overhead=True,4,5)
				 If FrontScanned_Underside = True OrElse 
       						(FrontScanned_Overhead = True AndAlso 
        						(GapControlMethod = "Active" Or ScanConfigAUsePandAMTBH = True)) Then
        						Return 3
...
'Error #BC30451:'GapControlMethod' is not declared. It may be inaccessible due to its protection level. occurred on line#79 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071605.vb | iswarning=False 
'Error #BC30451:'ScanConfigAUsePandAMTBH' is not declared. It may be inaccessible due to its protection level. occurred on line#79 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071605.vb | iswarning=False 
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071605.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071605.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071605.vb | iswarning=True 
