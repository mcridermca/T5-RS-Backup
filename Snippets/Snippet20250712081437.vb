	...
	If Me.Parent.UsePandAMTBH Then
		Select Case Me.Product_Spacing_Category 
			...
			Case 3
				...
				Select Case Parent.ShadowStatus
					Case "No"
			...
			Case 5
				...
				Select Case Parent.ShadowStatus
					Case "No"
						If MePandaMaxBoxWidth/2)+3 >= Me.PandaMinBoxLengt Then
							Result = Me.PandAAvgBoxWidth+1
						Else
							Result = Me.PandaMinBoxLength
						End If
...
Public [Scanner_Selected] as String
	...
	End Class
End Namespace
'Error #BC30205:End of statement expected. occurred on line#77 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712081437.vb | iswarning=False 
...
'Error #BC30451:'MePandaMaxBoxWidth' is not declared. It may be inaccessible due to its protection level. occurred on line#77 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712081437.vb | iswarning=False 
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712081437.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712081437.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712081437.vb | iswarning=True 
