				...
				'If(Or(FrontScanned_Underside = True ,And(FrontScanned_Overhead = true,Or(GapControlMethod="Active",ScanConfigAUsePandAMTBH=true))),3,If(FrontScanned_Overhead=True,4,5)
				 If FrontScanned_Underside = True OrElse 
       						(FrontScanned_Overhead = True AndAlso 
        						(Me.Parent.GapControlMethod = "Active" Me.Parent.UsePandAMTBH = True)) Then
        						Return 3
...
Public [Scanner_Selected] as String
	...
	End Class
End Namespace
'Error #BC30198:')' expected. occurred on line#79 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071629.vb | iswarning=False 
'Error #BC30198:')' expected. occurred on line#79 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071629.vb | iswarning=False 
...
'Error #BC42024:Unused local variable: 'ctx'. occurred on line#21 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071629.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyProp'. occurred on line#22 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071629.vb | iswarning=True 
'Error #BC42024:Unused local variable: '__rsMyPropName'. occurred on line#23 of module C:\ProgramData\RuleStream\2412.0000\Temp\Snippets\Snippet20250712071629.vb | iswarning=True 
