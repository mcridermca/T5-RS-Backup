...
'$ PartFamily: ADM_Application_Master
'$ GenerateDate: 07/21/2025 12:33:29
    ...
    Public Class [ADM_Application_Master]
    ...
    Private this as ADM_Application_Master = me
    ...
    InitPart("ADM_Application_Master", <a><![CDATA[ADM_Application_Master]]></a>.Value, 114, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:42:49")
    AddProperty("1404", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 9:35:54 PM")
    AddProperty("1403", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 9:35:24 PM")
    AddProperty("1553", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:42:49 AM")
    AddProperty("1405", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 9:36:16 PM")
    AddProperty("1400", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 9:34:53 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(125,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "7/8/2025 9:36:16 PM")
      
        oSubpart.AddVPF (115, "ADM_Application_Master_Row", "ADM_Application_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1290", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 9:35:54 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2365)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1289", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 9:35:24 PM", "Hash of Master Data Fields", "In Development",  0,2364)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1434", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:42:49 AM", "Is this a new Record", "In Development",  0,2602)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1291", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 9:36:16 PM", "Selected Row Identifier", "In Development",  0,2367)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1290", "-1", 2366)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1290; TYPE:PF
      Result = Me.ValidValues("Row_DBKeys").Count
      '   END FORMULA; PROP ID:1290; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Application_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1289; TYPE:PF
      result = ""
      '   END FORMULA; PROP ID:1289; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Application_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1434; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1434; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Application_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1291; TYPE:PF
      result = -1
      '   END FORMULA; PROP ID:1291; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Application_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1290; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1290; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Application_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
