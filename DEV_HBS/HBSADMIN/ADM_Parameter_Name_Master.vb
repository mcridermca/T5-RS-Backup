...
'$ PartFamily: ADM_Parameter_Name_Master
'$ GenerateDate: 07/21/2025 12:33:29
    ...
    Public Class [ADM_Parameter_Name_Master]
    ...
    Private this as ADM_Parameter_Name_Master = me
    ...
    InitPart("ADM_Parameter_Name_Master", <a><![CDATA[ADM_Parameter_Name_Master]]></a>.Value, 102, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:43:54")
    AddProperty("1292", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 7:53:43 PM")
    AddProperty("1291", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 7:53:18 PM")
    AddProperty("1560", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:43:54 AM")
    AddProperty("1293", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 7:53:56 PM")
    AddProperty("1288", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 7:52:55 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(117,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "7/8/2025 7:53:56 PM")
      
        oSubpart.AddVPF (103, "ADM_Parameter_Name_Master_Row", "ADM_Parameter_Name_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1190", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 7:53:43 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2261)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1189", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 7:53:18 PM", "Hash of Master Data Fields", "In Development",  0,2260)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1441", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:43:54 AM", "Is this a new Record", "In Development",  0,2609)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1191", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 7:53:56 PM", "Selected Row Identifier", "In Development",  0,2263)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1190", "-1", 2262)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Parameter_Name_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Parameter_Name_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1441; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1441; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Parameter_Name_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Parameter_Name_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1190; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1190; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Parameter_Name_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
