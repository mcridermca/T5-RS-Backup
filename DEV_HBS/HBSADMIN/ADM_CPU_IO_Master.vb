...
'$ GenerateDate: 07/21/2025 12:33:29
    ...
    Public Class [ADM_CPU_IO_Master]
    ...
    Private this as ADM_CPU_IO_Master = me
    ...
    InitPart("ADM_CPU_IO_Master", <a><![CDATA[ADM_CPU_IO_Master]]></a>.Value, 66, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:43:28")
    AddProperty("860", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 12:12:08 PM")
    AddProperty("859", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 12:11:30 PM")
    AddProperty("1557", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:43:28 AM")
    AddProperty("861", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 12:12:41 PM")
    AddProperty("856", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 12:11:10 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(84,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "6/27/2025 12:12:41 PM")
      
        oSubpart.AddVPF (67, "ADM_CPU_IO_Master_Row", "ADM_CPU_IO_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "794", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 12:12:08 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,1772)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "793", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 12:11:30 PM", "Hash of Master Data Fields", "In Development",  0,1771)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1438", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:43:28 AM", "Is this a new Record", "In Development",  0,2606)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "795", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 12:12:41 PM", "Selected Row Identifier", "In Development",  0,1774)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "794", "-1", 1773)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:794; TYPE:PF
      Result = Me.ValidValues("Row_DBKeys").Count
      '   END FORMULA; PROP ID:794; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_CPU_IO_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:793; TYPE:PF
      result = ""
      '   END FORMULA; PROP ID:793; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_CPU_IO_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1438; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1438; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_CPU_IO_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:795; TYPE:PF
      result = -1
      '   END FORMULA; PROP ID:795; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_CPU_IO_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:794; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:794; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_CPU_IO_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
