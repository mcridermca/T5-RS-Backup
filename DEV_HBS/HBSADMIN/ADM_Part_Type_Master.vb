...
'$ PartFamily: ADM_Part_Type_Master
'$ GenerateDate: 07/12/2025 14:08:17
    ...
    Public Class [ADM_Part_Type_Master]
    ...
    Private this as ADM_Part_Type_Master = me
    ...
    InitPart("ADM_Part_Type_Master", <a><![CDATA[ADM_Part_Type_Master]]></a>.Value, 105, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:44:20")
    AddProperty("1320", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:08:48 PM")
    AddProperty("1319", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:08:25 PM")
    AddProperty("1561", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:44:20 AM")
    AddProperty("1321", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:09:19 PM")
    AddProperty("1316", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:07:59 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(119,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "7/8/2025 8:09:19 PM")
      
        oSubpart.AddVPF (106, "ADM_Part_Type_Master_Row", "ADM_Part_Type_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1215", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:08:48 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2287)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1214", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:08:25 PM", "Hash of Master Data Fields", "In Development",  0,2286)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1442", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:44:20 AM", "Is this a new Record", "In Development",  0,2610)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1216", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:09:19 PM", "Selected Row Identifier", "In Development",  0,2289)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1215", "-1", 2288)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Part_Type_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Part_Type_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1442; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1442; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Part_Type_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Part_Type_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1215; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1215; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Part_Type_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
