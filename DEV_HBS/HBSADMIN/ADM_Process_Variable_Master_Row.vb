...
'$ GenerateDate: 07/01/2025 01:42:37
    ...
    Public Class [ADM_Process_Variable_Master_Row]
    ...
    Private this as ADM_Process_Variable_Master_Row = me
    ...
    AddProperty("1024", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 7:37:41 PM")
      ...
      oSubpart = AddSubpart(102,"DbInfo", <a><![CDATA[DB Info Part Family]]></a>.Value, "FD", "Subpart for Database Information for this Part", "Master Audit", 9999, "", "GLOBAL\H601424", "6/27/2025 8:39:48 PM")
      
        oSubpart.AddVPF (92, "ADM_Process_Variable_Master_Row_dbInfo", "ADM_Process_Variable_Master_Row_dbInfo")
    ...
    ctx = ContextId
          ...
          InitProperty("Created_By", "1060", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:34:32 PM", "User that created the record", "In Development",  0,2047)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Created_On", "1061", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:35:09 PM", "Date User Created record", "In Development",  0,2048)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1065", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:36:53 PM", "Is this a new Record", "In Development",  0,2052)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_New", "1066", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:37:21 PM", "Is this a Dirty / Changed Record", "In Development",  0,2053)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Modified_By", "1067", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:37:35 PM", "User that modified the record", "In Development",  0,2054)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1062", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:35:44 PM", "Hash of Master Data Fields", "In Development",  0,2049)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("DbInfo", 89, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "6/27/2025 8:39:48 PM", "Subpart for Database Information for this Part", "In Development", "N",0,206,207)
...
End If
      ...
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Created_By", ex.Message)
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Created_On", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
If Me.Is_New Then Result = True
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Is_New", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Modified_By", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Modified_On", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Deleted", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Is_Active", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Process_Variable", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Sort_Order", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Process_Variable_Master_Id", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
Next P
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:89; TYPE:PN
      
      '   END FORMULA; SUB ID:89; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_DbInfo_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:89; TYPE:QF
      Result = 0
...
If Me.Properties(PKField).Value > 0 Then
	Result = 1
End If
      '   END FORMULA; SUB ID:89; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_DbInfo_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:89; TYPE:OP
      result = "ADM_Process_Variable_Master_Row_dbInfo"
      '   END FORMULA; SUB ID:89; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Process_Variable_Master_Row.Formula_DbInfo_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
