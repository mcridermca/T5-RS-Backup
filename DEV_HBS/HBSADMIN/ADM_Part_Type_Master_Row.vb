...
'$ GenerateDate: 07/21/2025 12:33:29
    ...
    InitPart("ADM_Part_Type_Master_Row", <a><![CDATA[ADM_Part_Type_Master_Row]]></a>.Value, 106, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601422", "07/14/2025 12:15:55")
    ...
    AddProperty("1325", "Deleted", <a><![CDATA[Deleted]]></a>.Value, "Deleted Flag", "Boolean","","Master Data","FD", 9999, "", 0,0, "", "", "GLOBAL\H601422", "7/14/2025 12:15:55 PM")
    ...
    AddProperty("1333", "Sort_Order", <a><![CDATA[Sort_Order]]></a>.Value, "First Sort Order 0 = Default = 100 , Adjust Accordingly", "Long","","Master Data","FD", 9999, "", 0,0, "", "", "GLOBAL\H601422", "7/14/2025 2:30:55 AM")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Deleted", "1220", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601422", "7/14/2025 12:15:55 PM", "Deleted Flag", "In Development",  0,2293)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sort_Order", "1228", "0", "999", "Y", "","", 0, "-1", 1, "", "N","0",  "GLOBAL\H601422", "7/14/2025 2:30:55 AM", "First Sort Order 0 = Default = 100 , Adjust Accordingly", "In Development",  0,2301)
        End If
            If Incontext("-1", ctx) Then
