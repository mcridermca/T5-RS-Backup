...
'$ PartFamily: ADM_Point_Type_Master
'$ GenerateDate: 07/21/2025 12:33:29
    ...
    Public Class [ADM_Point_Type_Master]
    ...
    Private this as ADM_Point_Type_Master = me
    ...
    InitPart("ADM_Point_Type_Master", <a><![CDATA[ADM_Point_Type_Master]]></a>.Value, 87, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:44:57")
    AddProperty("1123", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 8:23:15 PM")
    AddProperty("1122", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 8:22:54 PM")
    AddProperty("1563", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:44:57 AM")
    AddProperty("1124", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 8:23:50 PM")
    AddProperty("1020", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 7:37:41 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(99,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "6/27/2025 8:23:50 PM")
      
        oSubpart.AddVPF (88, "ADM_Point_Type_Master_Row", "ADM_Point_Type_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1033", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:23:15 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2018)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1032", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:22:54 PM", "Hash of Master Data Fields", "In Development",  0,2017)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1444", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:44:57 AM", "Is this a new Record", "In Development",  0,2612)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1034", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/27/2025 8:23:50 PM", "Selected Row Identifier", "In Development",  0,2020)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1033", "-1", 2019)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Point_Type_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Point_Type_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1444; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1444; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Point_Type_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Point_Type_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1033; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1033; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Point_Type_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
