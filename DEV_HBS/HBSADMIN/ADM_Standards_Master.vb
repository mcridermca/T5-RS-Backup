...
'$ PartFamily: ADM_Standards_Master
'$ GenerateDate: 07/12/2025 14:08:17
    ...
    Public Class [ADM_Standards_Master]
    ...
    Private this as ADM_Standards_Master = me
    ...
    InitPart("ADM_Standards_Master", <a><![CDATA[ADM_Standards_Master]]></a>.Value, 108, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:45:28")
    AddProperty("1348", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:27:34 PM")
    AddProperty("1347", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:27:01 PM")
    AddProperty("1567", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:45:28 AM")
    AddProperty("1349", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:27:46 PM")
    AddProperty("1344", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 8:26:26 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(121,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601424", "7/8/2025 8:27:46 PM")
      
        oSubpart.AddVPF (109, "ADM_Standards_Master_Row", "ADM_Standards_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1240", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:27:34 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2313)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1239", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:27:01 PM", "Hash of Master Data Fields", "In Development",  0,2312)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1448", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:45:28 AM", "Is this a new Record", "In Development",  0,2616)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1241", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 8:27:46 PM", "Selected Row Identifier", "In Development",  0,2315)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1240", "-1", 2314)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1240; TYPE:PF
      Result = Me.ValidValues("Row_DBKeys").Count
      '   END FORMULA; PROP ID:1240; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Standards_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1239; TYPE:PF
      result = ""
      '   END FORMULA; PROP ID:1239; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Standards_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1448; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1448; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Standards_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1241; TYPE:PF
      result = -1
      '   END FORMULA; PROP ID:1241; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Standards_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1240; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1240; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Standards_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
