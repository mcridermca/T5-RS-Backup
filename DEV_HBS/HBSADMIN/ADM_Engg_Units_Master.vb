...
'$ PartFamily: ADM_Engg_Units_Master
'$ GenerateDate: 07/12/2025 14:08:17
    ...
    Public Class [ADM_Engg_Units_Master]
    ...
    Private this as ADM_Engg_Units_Master = me
    ...
    InitPart("ADM_Engg_Units_Master", <a><![CDATA[ADM_Engg_Units_Master]]></a>.Value, 93, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "07/11/2025 09:43:46")
    AddProperty("1191", "Row_DBKeys", <a><![CDATA[Row_DBKeys]]></a>.Value, "DataBase Extract of Key Values for Lines", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/30/2025 12:01:20 PM")
    AddProperty("1190", "Data_Hash", <a><![CDATA[Data_Hash]]></a>.Value, "Hash of Master Data Fields", "String","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/30/2025 12:01:03 PM")
    AddProperty("1559", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601423", "7/11/2025 9:43:46 AM")
    AddProperty("1192", "Selected_Row", <a><![CDATA[Selected_Row]]></a>.Value, "Selected Row Identifier", "Long","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/30/2025 12:02:01 PM")
    AddProperty("1187", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/30/2025 12:00:31 PM")
    
      AddValidValue("Row_DBKeys")
    
      oSubpart = AddSubpart(110,"Rows", <a><![CDATA[Rows]]></a>.Value, "MN", "Subpart for All Data Rows for this Master", "Master SubPart Collection", 9999, "", "GLOBAL\H601423", "6/30/2025 1:36:36 PM")
      
        oSubpart.AddVPF (94, "ADM_Engg_Units_Master_Row", "ADM_Engg_Units_Master_Row")
    ...
    ctx = ContextId
          ...
          InitProperty("Row_DBKeys", "1098", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/30/2025 12:01:20 PM", "DataBase Extract of Key Values for Lines", "In Development",  0,2120)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "1097", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/30/2025 12:01:03 PM", "Hash of Master Data Fields", "In Development",  0,2119)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "1440", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601423", "7/11/2025 9:43:46 AM", "Is this a new Record", "In Development",  0,2608)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Selected_Row", "1099", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/30/2025 12:02:01 PM", "Selected Row Identifier", "In Development",  0,2122)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Row_DBKeys_ValidValues", "1098", "-1", 2121)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Engg_Units_Master.Formula_Row_DBKeys", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Engg_Units_Master.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1440; TYPE:PF
      Result = False
If (Me.Rows.Count > 0) Then
	...
	End If
End If
      '   END FORMULA; PROP ID:1440; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Engg_Units_Master.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Engg_Units_Master.Formula_Selected_Row", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1098; TYPE:VV
...
Result = MakeValidValueKeyFromDatabase($"[{TableName}]", $"[{PK_Name}]", $"[{PK_Name}]", $"WHERE [{PK_Name}] > " & FormatCriteria(0) & $" ORDER BY [{PK_Name}]")
      '   END FORMULA; PROP ID:1098; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Engg_Units_Master.Formula_Row_DBKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
