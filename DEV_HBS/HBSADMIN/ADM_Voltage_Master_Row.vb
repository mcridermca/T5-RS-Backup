...
'$ GenerateDate: 07/01/2025 01:42:37
    ...
    Public Class [ADM_Voltage_Master_Row]
    ...
    Private this as ADM_Voltage_Master_Row = me
    ...
    InitPart("ADM_Voltage_Master_Row", <a><![CDATA[ADM_Voltage_Master_Row]]></a>.Value, 52, "HBSADMIN",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "06/30/2025 17:17:58")
    ...
    AddProperty("717", "Is_Dirty", <a><![CDATA[Is_Dirty]]></a>.Value, "Is this a new Record", "Boolean","","Master Audit","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/20/2025 6:34:41 PM")
    ...
    AddProperty("711", "Sort_Order", <a><![CDATA[Sort_Order]]></a>.Value, "First Default Sort Order 0 = Default = 100 , Adjust Accordingly", "Long","","Master Data","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/20/2025 7:29:07 PM")
    ...
    AddProperty("705", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:43:08 PM")
      ...
      oSubpart = AddSubpart(71,"DbInfo", <a><![CDATA[DB Info Part Family]]></a>.Value, "FD", "Subpart for Database Information for this Part", "Master Audit", 9999, "", "GLOBAL\H601424", "6/20/2025 4:15:30 PM")
      
        oSubpart.AddVPF (53, "ADM_Voltage_Master_Row_dbInfo", "ADM_Voltage_Master_Row_dbInfo")
    ...
    ctx = ContextId
          ...
          InitProperty("Created_By", "662", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:46:12 PM", "User that created the record", "In Development",  0,1548)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Created_On", "663", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:46:54 PM", "Date User Created record", "In Development",  0,1549)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Data_Hash", "668", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:48:49 PM", "Hash of Master Data Fields", "In Development",  0,1554)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_Dirty", "666", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/20/2025 6:34:41 PM", "Is this a new Record", "In Development",  0,1552)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Is_New", "667", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/20/2025 6:34:41 PM", "Is this a Dirty / Changed Record", "In Development",  0,1553)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Modified_By", "664", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:47:17 PM", "User that modified the record", "In Development",  0,1550)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sort_Order", "660", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:45:21 PM", "First Sort Order 0 = Default = 100 , Adjust Accordingly", "In Development",  0,1546)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Voltage_Master_ID", "659", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "6/19/2025 7:44:58 PM", "Table Primary Key", "In Development",  0,1545)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("DbInfo", 69, "", "", "Y", 0, "-1", "", "GLOBAL\H601424", "6/20/2025 4:15:30 PM", "Subpart for Database Information for this Part", "In Development", "N",0,163,173)
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:662; TYPE:PF
...
End If
      '   END FORMULA; PROP ID:662; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Created_By", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:663; TYPE:PF
      If Me.DBInfo.Quantity = 1 Then
	Dim MyPropertyName As String  = Me.CurrentProperty.Name
	Result = Me.DBInfo(1).Properties(MyPropertyName).DisplayValue
End If
      '   END FORMULA; PROP ID:663; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Created_On", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:668; TYPE:PF
      Result = ""
...
For Each p As PropertySF In Me.properties
	...
	End If
Next P
      '   END FORMULA; PROP ID:668; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Data_Hash", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:666; TYPE:PF
      Result = True
If Me.dbinfo.Count = 1 Then
	Result = (Me.Data_Hash <> Me.dbinfo(1).Data_Hash)
End If
If Me.Is_New Then Result = True
      '   END FORMULA; PROP ID:666; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Is_Dirty", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:667; TYPE:PF
      Result = Me.DBInfo.Count = 0
      '   END FORMULA; PROP ID:667; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Is_New", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:664; TYPE:PF
      If Me.DBInfo.Quantity = 1 Then
	Dim MyPropertyName As String  = Me.CurrentProperty.Name
	Result = Me.DBInfo(1).Properties(MyPropertyName).DisplayValue
End If
      '   END FORMULA; PROP ID:664; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Modified_By", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:665; TYPE:PF
      If Me.DBInfo.Quantity = 1 Then
	Dim MyPropertyName As String  = Me.CurrentProperty.Name
	Result = Me.DBInfo(1).Properties(MyPropertyName).DisplayValue
End If
      '   END FORMULA; PROP ID:665; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Modified_On", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Deleted", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Is_Active", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:660; TYPE:PF
      Result = 100
If Me.DBInfo.Quantity = 1 Then
	Dim MyPropertyName As String  = Me.CurrentProperty.Name
	Result = Me.DBInfo(1).Properties(MyPropertyName).DisplayValue
End If
      '   END FORMULA; PROP ID:660; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Sort_Order", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:661; TYPE:PF
      If Me.DBInfo.Quantity = 1 Then
	Dim MyPropertyName As String  = Me.CurrentProperty.Name
	Result = Me.DBInfo(1).Properties(MyPropertyName).DisplayValue
End If
      '   END FORMULA; PROP ID:661; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Voltage", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:659; TYPE:PF
...
End If
      '   END FORMULA; PROP ID:659; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_Voltage_Master_ID", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:69; TYPE:PN
      
      '   END FORMULA; SUB ID:69; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_DbInfo_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:69; TYPE:QF
      Result = 0
...
If Me.Properties(PKField).Value > 0 Then
	Result = 1
End If
      '   END FORMULA; SUB ID:69; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_DbInfo_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:69; TYPE:OP
      result = "ADM_Voltage_Master_Row_dbInfo"
      '   END FORMULA; SUB ID:69; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " ADM_Voltage_Master_Row.Formula_DbInfo_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
