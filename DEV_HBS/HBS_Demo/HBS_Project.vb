...
'$ GenerateDate: 06/27/2025 20:11:04
    ...
    InitPart("HBS_Project", <a><![CDATA[HBS Project]]></a>.Value, 2, "HBS_Demo",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "06/19/2025 19:41:00")
    AddProperty("10", "District", <a><![CDATA[District]]></a>.Value, "District for the project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("13", "HoneywellEngineer", <a><![CDATA[Honeywell Engineer]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("8", "Pole", <a><![CDATA[Pole]]></a>.Value, "Super-regional distribution point; collection of regions.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("12", "ProjectName", <a><![CDATA[Project Name]]></a>.Value, "The name of the project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("11", "ProjectNumber", <a><![CDATA[Project Number]]></a>.Value, "The project number, sometimes project code.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("9", "Region", <a><![CDATA[Region]]></a>.Value, "Region for the project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("14", "SiteAddress", <a><![CDATA[Site Address]]></a>.Value, "The address of the site of the project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("119", "Status_Text", <a><![CDATA[Status_Text]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("133", "Story_Point_Data_1", <a><![CDATA[Story_Point_Data_1]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("120", "Story_Point_Data_2", <a><![CDATA[Story_Point_Data_2]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("134", "Story_Point_Data_3", <a><![CDATA[Story_Point_Data_3]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("135", "Story_Point_Data_4", <a><![CDATA[Story_Point_Data_4]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("136", "Story_Point_Data_5", <a><![CDATA[Story_Point_Data_5]]></a>.Value, "The name or code of the Honeywell engineer on this project.", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
    AddProperty("2", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\SVRSDevAdmin", "2/21/2025 6:53:50 PM")
      ...
      oSubpart = AddSubpart(10,"Groups", <a><![CDATA[Groups]]></a>.Value, "FD", "", "Subparts and Connections", 9999, "", "GLOBAL\H601423", "3/17/2025 12:10:46 PM")
    ...
    ctx = ContextId
        ...
        InitSubpart("Groups", 10, "", "", "Y", 0, "-1", "", "GLOBAL\H601421", "3/14/2025 2:44:09 AM", "", "In Development", "Y",0,22,21)
...
'Full list where?
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:10; TYPE:PN
      
      '   END FORMULA; SUB ID:10; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HBS_Project.Formula_Groups_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:10; TYPE:QF
      result = 1
      '   END FORMULA; SUB ID:10; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HBS_Project.Formula_Groups_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:10; TYPE:OP
      result = "Group"
      '   END FORMULA; SUB ID:10; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HBS_Project.Formula_Groups_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
