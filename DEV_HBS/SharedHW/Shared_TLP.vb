...
'$ GenerateDate: 06/19/2025 19:33:03
    ...
    #Region " Properties, Subparts, Connections "
      ...
      Public ReadOnly Property [CORA_Info_Shared]() As Rulestream.Kernel.Subpart
      Get
      Return Subparts("CORA_Info_Shared")
      End Get
      End Property
    ...
    InitPart("Shared_TLP", <a><![CDATA[Shared Top-Level Part]]></a>.Value, 18, "SharedHW",  "", "", False, True, "In Development", "", "", "", "", "",  "GLOBAL\H601423", "03/17/2025 11:45:08")
    AddProperty("206", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601423", "3/17/2025 11:15:06 AM")
    
      oSubpart = AddSubpart(17,"CORA_Info_Shared", <a><![CDATA[CORA Info - Shared]]></a>.Value, "FD", "A subpart in the Shared application for CORA info.", "CORA Data", 9999, "CORA", "GLOBAL\H601423", "3/17/2025 11:45:08 AM")
    ...
    End Sub
        ...
        oProcessStep = AddProcessStep(7, "Step 1", "This process step was created automatically by RuleStream.", 1, 3, 1, 1, 50, 50)
        oProcessStep.AddPath("Shared_TLP")
    ...
    ctx = ContextId
        ...
        InitSubpart("CORA_Info_Shared", 17, "", "", "Y", 0, "-1", "", "GLOBAL\H601423", "3/17/2025 11:45:08 AM", "", "In Development", "Y",0,37,36)
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " Shared_TLP.Process_DefaultProcess_Step_1_STATUS", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Shared_TLP.Process_DefaultProcess_Step_1_COMMENT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_CORA_Info_Shared_PARTNAMES() as String
      
      Dim Result as String = ""
      Dim ctx as Object
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:17; TYPE:PN
      
      '   END FORMULA; SUB ID:17; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Shared_TLP.Formula_CORA_Info_Shared_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_CORA_Info_Shared_QUANTITY() as Integer 'Long
      
      Dim Result as Integer = 0 'Long
      Dim ctx as Object
      Try
      ctx = this
      If Me.Subparts("CORA_Info_Shared").GetDebugState(Rulestream.Kernel.Subpart.FormulaDebugTypes.QUANTITY_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:17; TYPE:QF
      result = 1
      '   END FORMULA; SUB ID:17; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Shared_TLP.Formula_CORA_Info_Shared_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_CORA_Info_Shared_OPTIMALPARTFAMILY() as String
      
      Dim Result as String = ""
      Dim ctx as Object
      Try
      ctx = this
      If Me.Subparts("CORA_Info_Shared").GetDebugState(Rulestream.Kernel.Subpart.FormulaDebugTypes.OPF_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:17; TYPE:OP
      result = "CORA_Project_Information"
      '   END FORMULA; SUB ID:17; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Shared_TLP.Formula_CORA_Info_Shared_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
