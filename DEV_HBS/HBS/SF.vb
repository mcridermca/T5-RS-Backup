...
'$ GenerateDate: 06/27/2025 20:11:14
    ...
    InitPart("SF", <a><![CDATA[SF]]></a>.Value, 42, "HBS",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "06/19/2025 19:41:00")
    AddProperty("565", "LOCATION", <a><![CDATA[LOCATION]]></a>.Value, "", "Point3D","","Design","FD", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:50:35 AM")
    AddProperty("557", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:08:49 AM")
    
      oSubpart = AddSubpart(52,"Layouts", <a><![CDATA[Layouts]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
      
        oSubpart.AddVPF (30, "Layout", "Layout")
      oSpec = AddSpec("22","", 16, "DWG_SF", "", "GLOBAL\H601424", "2025-06-19T19:41:00.377", "DWG_SF")
      oSpec.Attributes.Add("DIM", "BLOCKFILE", <a><![CDATA[AHU-CV1 1-Ref.dwg]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
      oSpec.Attributes.Add("DIM", "BLOCKNAME", <a><![CDATA[AHU_CV1_SF]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
    ...
    ctx = ContextId
          ...
          InitProperty("LOCATION", "525", "", "", "N", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H599123", "4/24/2025 6:50:35 AM", "", "In Development",  0,1242)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Layouts", 52, "", "", "Y", 0, "-1", "", "GLOBAL\H599123", "4/24/2025 6:49:10 AM", "", "In Development", "N",0,119,118)
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:525; TYPE:PF
      Return "13.3333,14.8892,0"
      '   END FORMULA; PROP ID:525; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " SF.Formula_LOCATION", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " SF.Formula_Layouts_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " SF.Formula_Layouts_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " SF.Formula_Layouts_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
