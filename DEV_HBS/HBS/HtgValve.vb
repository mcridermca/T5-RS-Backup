...
'$ GenerateDate: 06/27/2025 20:11:14
    ...
    InitPart("HtgValve", <a><![CDATA[HtgValve]]></a>.Value, 40, "HBS",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "06/19/2025 19:41:00")
    AddProperty("563", "LOCATION", <a><![CDATA[LOCATION]]></a>.Value, "", "Point3D","","Design","FD", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:46:17 AM")
    AddProperty("555", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:07:27 AM")
    
      oSubpart = AddSubpart(50,"Layouts", <a><![CDATA[Layouts]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
      
        oSubpart.AddVPF (30, "Layout", "Layout")
      oSpec = AddSpec("20","", 16, "DWG_Htg_Valve", "", "GLOBAL\H601424", "2025-06-19T19:41:00.377", "DWG_Htg_Valve")
      oSpec.Attributes.Add("DIM", "BLOCKFILE", <a><![CDATA[AHU-CV1 1-Ref.dwg]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
      oSpec.Attributes.Add("DIM", "BLOCKNAME", <a><![CDATA[AHU_CV1_HtgVlv_Hv]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
    ...
    ctx = ContextId
          ...
          InitProperty("LOCATION", "523", "", "", "N", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H599123", "4/24/2025 6:46:17 AM", "", "In Development",  0,1240)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Layouts", 50, "", "", "Y", 0, "-1", "", "GLOBAL\H599123", "4/24/2025 6:45:00 AM", "", "In Development", "N",0,115,114)
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:523; TYPE:PF
      Return "10.1,13.8,0"
      '   END FORMULA; PROP ID:523; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HtgValve.Formula_LOCATION", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HtgValve.Formula_Layouts_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HtgValve.Formula_Layouts_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HtgValve.Formula_Layouts_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
