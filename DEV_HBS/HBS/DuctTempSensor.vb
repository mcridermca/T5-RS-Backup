...
'$ GenerateDate: 07/12/2025 14:09:33
    ...
    Private this as DuctTempSensor = me
    ...
    InitPart("DuctTempSensor", <a><![CDATA[DuctTempSensor]]></a>.Value, 36, "HBS",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "06/19/2025 19:41:00")
    AddProperty("559", "LOCATION", <a><![CDATA[LOCATION]]></a>.Value, "", "Point3D","","Design","FD", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:24:22 AM")
    AddProperty("551", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:04:00 AM")
    
      oSubpart = AddSubpart(46,"Layouts", <a><![CDATA[Layouts]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
      
        oSubpart.AddVPF (30, "Layout", "Layout")
      oSpec = AddSpec("16","", 16, "DWG_DuctTemp", "", "GLOBAL\H601424", "2025-06-19T19:41:00.377", "DWG_DuctTemp")
      oSpec.Attributes.Add("DIM", "BLOCKFILE", <a><![CDATA[AHU-CV1 1-Ref.dwg]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
      oSpec.Attributes.Add("DIM", "BLOCKNAME", <a><![CDATA[DuctTempSen2Wicon]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
    ...
    ctx = ContextId
          ...
          InitProperty("LOCATION", "519", "", "", "N", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H599123", "4/24/2025 6:24:22 AM", "", "In Development",  0,1236)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Layouts", 46, "", "", "Y", 0, "-1", "", "GLOBAL\H599123", "4/24/2025 6:22:06 AM", "", "In Development", "N",0,107,106)
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:519; TYPE:PF
      Return "15.6,15.7,0"
      '   END FORMULA; PROP ID:519; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DuctTempSensor.Formula_LOCATION", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DuctTempSensor.Formula_Layouts_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DuctTempSensor.Formula_Layouts_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DuctTempSensor.Formula_Layouts_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
