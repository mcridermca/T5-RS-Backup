...
'$ GenerateDate: 06/19/2025 19:33:03
    ...
    Select Case specName & "_" & context
      ...
      Case "SelectedElementIndex_"
      Formula_SelectedElementIndex_WHENCHANGED(Value, OldValue)
    ...
    InitPart("PowerSupplyModel", <a><![CDATA[Power Supply Model]]></a>.Value, 48, "HBS",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601421", "06/19/2025 04:39:14")
    AddProperty("686", "button_AddPowerSupply", <a><![CDATA[button_Add Power Supply]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601421", "6/19/2025 4:39:14 AM")
    AddProperty("683", "PowerSupplyPick", <a><![CDATA[Power Supply Pick]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601421", "6/18/2025 6:22:57 PM")
    AddProperty("685", "SelectedElementIndex", <a><![CDATA[Selected Element Index]]></a>.Value, "", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601421", "6/18/2025 8:25:18 PM")
    AddProperty("682", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601421", "6/18/2025 4:47:52 PM")
    
      AddPropertyExtended(686,"button_AddPowerSupply", "640", "EXTWC   ", "WhenChanged", "BUTTONCLICK", "GLOBAL\H601421", "6/19/2025 4:39:14 AM")
    
      AddValidValue("PowerSupplyPick")
    
      oSubpart = AddSubpart(68,"PowerSupplies", <a><![CDATA[Power Supplies]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601421", "6/18/2025 5:07:55 PM")
      
        oSubpart.AddVPF (22, "PowerSupply", "Power Supply")
      
      oConnection = AddConnection("ProjectElements", <a><![CDATA[Project Elements]]></a>.Value, "", "61", "OM", 0, "","General", 9999, "", "GLOBAL\H601421", "6/18/2025 8:16:32 PM")
      
        oConnection.AddVPF(22, "PowerSupply")
      
        oConnection.AddVPF(48, "PowerSupplyModel")
      
      oConnection = AddConnection("SelectedElement", <a><![CDATA[Selected Element]]></a>.Value, "", "62", "OO", 0, "","General", 9999, "", "GLOBAL\H601421", "6/18/2025 8:40:38 PM")
      
        oConnection.AddVPF(17, "HBSSystem")
      
        oConnection.AddVPF(48, "PowerSupplyModel")
      
      oConnection = AddConnection("Transformers", <a><![CDATA[Transformers]]></a>.Value, "This is a list of power supplies that are at project level (vs. system level)", "63", "OM", 0, "","General", 9999, "", "GLOBAL\H601421", "6/19/2025 4:34:08 AM")
    ...
    ctx = ContextId
          ...
          InitProperty("button_AddPowerSupply", "640", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601421", "6/19/2025 4:39:14 AM", "", "In Development",  0,1522)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("PowerSupplyPick", "637", "", "", "Y", "","", 1, "-1", 1, "", "N","0",  "GLOBAL\H601421", "6/18/2025 6:22:57 PM", "", "In Development",  0,1517)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("SelectedElementIndex", "639", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601421", "6/18/2025 8:25:18 PM", "", "In Development",  0,1520)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitConnection("SelectedElement", "56", "","", "Y", 0, "-1", "", "GLOBAL\H601421", "6/18/2025 8:40:38 PM", "", "In Development", "N",101)
...
Result = String.Empty
      ...
      Public Function Formula_button_AddPowerSupply_USERCHANGE() as Boolean
              ...
              Result = IsConnected(SelectedElement)
...
End Select
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Sub Formula_SelectedElementIndex_WHENCHANGED(ByRef Value as Object, ByVal OldValue as Object)
      
      Dim ctx as Object
      Try
      ctx = this
      If Me.Properties("SelectedElementIndex").GetDebugState(Rulestream.Kernel.PropertySF.FormulaDebugTypes.WHENCHANGED_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:639; TYPE:WC
      g_RsEngineer.RefreshModelViews(0)
      '   END FORMULA; PROP ID:639; TYPE:WC
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " PowerSupplyModel.Formula_SelectedElementIndex_WHENCHANGED", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      End Sub
