...
'$ GenerateDate: 07/21/2025 12:30:00
    ...
    Private this as DaTemp_TNL2 = me
    ...
    InitPart("DaTemp_TNL2", <a><![CDATA[DaTemp_TNL2]]></a>.Value, 35, "HBS",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "06/19/2025 19:41:00")
    AddProperty("558", "LOCATION", <a><![CDATA[LOCATION]]></a>.Value, "", "Point3D","","Design","FD", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:20:51 AM")
    AddProperty("550", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H599123", "4/24/2025 6:02:27 AM")
    
      oSubpart = AddSubpart(45,"Layouts", <a><![CDATA[Layouts]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "6/19/2025 7:41:00 PM")
      
        oSubpart.AddVPF (30, "Layout", "Layout")
      oSpec = AddSpec("15","", 16, "DWG_DaTemp_TNL2", "", "GLOBAL\H601424", "2025-06-19T19:41:00.377", "DWG_DaTemp_TNL2")
      oSpec.Attributes.Add("DIM", "BLOCKFILE", <a><![CDATA[AHU-CV1 1-Ref.dwg]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
      oSpec.Attributes.Add("DIM", "BLOCKNAME", <a><![CDATA[AHU_CV1_DaTemp_TNL2]]></a>.Value, "",  <a><![CDATA[]]></a>.Value, 0, 1)
    ...
    ctx = ContextId
          ...
          InitProperty("LOCATION", "518", "", "", "N", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H599123", "4/24/2025 6:20:51 AM", "", "In Development",  0,1235)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Layouts", 45, "", "", "Y", 0, "-1", "", "GLOBAL\H599123", "4/24/2025 6:17:42 AM", "", "In Development", "N",0,105,104)
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:518; TYPE:PF
      Return "14.5,13.7,0"
      '   END FORMULA; PROP ID:518; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DaTemp_TNL2.Formula_LOCATION", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DaTemp_TNL2.Formula_Layouts_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DaTemp_TNL2.Formula_Layouts_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " DaTemp_TNL2.Formula_Layouts_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
