...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		...
		arr(5) = "123ControllerPhysicalController Physical"
		arr(6) = "19CORA_Project_Information (SharedHW)CORA Project Information"
		arr(7) = "33CV1CV1"
		arr(8) = "34CV2CV2"
		arr(9) = "35DaTemp_TNL2DaTemp_TNL2"
		arr(10) = "5DeviceDevice"
		arr(11) = "10Device_DBDetailDevice_DBDetail"
		arr(12) = "122DevicePhysicalDevice Physical"
		arr(13) = "29DrawingDrawing"
		arr(14) = "36DuctTempSensorDuctTempSensor"
		arr(15) = "37EMFEarthingEMFEarthing"
		arr(16) = "44FacilityModelFacility Model"
		arr(17) = "38FiltAlmFiltAlm"
		arr(18) = "46FloorFloor"
		arr(19) = "13GroupGroup"
		arr(20) = "119HBS_SchedulesHBS_Schedules"
		arr(21) = "17HBSSystemHBS System"
		arr(22) = "39HLFrameHLFrame"
		arr(23) = "40HtgValveHtgValve"
		arr(24) = "30LayoutLayout"
		arr(25) = "31LayoutViewLayout View"
		arr(26) = "41OaDmprOaDmpr"
		arr(27) = "20PartSearchResultPart Search Result"
		arr(28) = "4PlantPlant"
		arr(29) = "24PlantModelPlant Model"
		arr(30) = "101PLI_InformationPLI Information"
		arr(31) = "22PowerSupplyPower Supply"
		arr(32) = "48PowerSupplyModelPower Supply Model"
		arr(33) = "47Project_InformationProject_Information"
		arr(34) = "118ScheduleSchedule"
		arr(35) = "42SFSF"
		arr(36) = "16SiteSite"
		arr(37) = "121ValveValve"
		arr(38) = "21WireWire"
