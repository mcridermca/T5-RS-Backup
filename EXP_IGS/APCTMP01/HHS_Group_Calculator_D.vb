...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("HHS_Group_Calculator_D", <a><![CDATA[HHS Group Calculator D]]></a>.Value, 344, "APCTMP01",  "N", "N", False, False, "In Development", "", "HHS Group D Calculator", "", "", "",  "GLOBAL\H601424", "04/30/2025 20:25:14")
    AddProperty("2393", "Component_Item_Keys", <a><![CDATA[Component Item Keys]]></a>.Value, "DBLookup Keys for SubPart Components", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/29/2025 5:08:07 PM")
    ...
    AddProperty("2246", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/23/2025 12:08:22 PM")
      ...
      oConnection = AddConnection("My_HHS_Items", <a><![CDATA[My HHS Items]]></a>.Value, "HHS Items Specific To Me", "93", "OM", 0, "","General", 9999, "", "GLOBAL\H601424", "4/28/2025 4:40:16 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Component_Item_Keys", "2039", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/29/2025 5:08:07 PM", "DBLookup Keys for SubPart Components", "In Development",  0,3348)
        End If
            If Incontext("-1", ctx) Then
    ...
    ctx = ContextId
        ...
        InitValidValue("Component_Item_Keys_ValidValues", "2039", "-1", 3361)
        End If
            If Incontext("-1", ctx) Then
    ...
    ctx = ContextId
        ...
        InitConnection("My_HHS_Items", "73", "N","N", "N", 0, "-1", "", "GLOBAL\H601424", "4/28/2025 4:40:16 PM", "HHS Items Specific To Me", "In Development", "Y",107)
