...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("HHS_BOM_Item", <a><![CDATA[HHS BOM Item]]></a>.Value, 358, "APCTMP01",  "N", "N", False, False, "In Development", "", "HHS BOM Rollup Item", "", "", "",  "GLOBAL\H601424", "05/29/2025 14:58:33")
    AddProperty("2474", "ExtdCost", <a><![CDATA[Extended Cost]]></a>.Value, "Extended Cost", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2475", "Item_Description", <a><![CDATA[Item Description]]></a>.Value, "Item Description", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2476", "Part_Number_ERP", <a><![CDATA[Part Number ERP]]></a>.Value, "Unique Part Number", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2477", "Qty", <a><![CDATA[Qty]]></a>.Value, "Qty", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2478", "Sort_Order_1", <a><![CDATA[Sort Order 1]]></a>.Value, "Sorting Order (Overridable)", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2479", "UnitCost", <a><![CDATA[UnitCost]]></a>.Value, "Unit Cost", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    AddProperty("2467", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 7:02:17 PM")
    
      oConnection = AddConnection("My_Parts", <a><![CDATA[My Parts]]></a>.Value, "Collection of Items with same part number", "105", "OM", 0, "","General", 9999, "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("ExtdCost", "2116", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Extended Cost", "In Development",  0,3405)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Item_Description", "2117", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Item Description", "In Development",  0,3399)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Part_Number_ERP", "2118", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Unique Part Number", "In Development",  0,3378)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Qty", "2119", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Qty", "In Development",  0,3401)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sort_Order_1", "2120", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Sorting Order (Overridable)", "In Development",  0,3407)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("UnitCost", "2121", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Unit Cost", "In Development",  0,3403)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitConnection("My_Parts", "85", "N","N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 2:58:33 PM", "Collection of Items with same part number", "In Development", "Y",144)
