...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("CAE_Elec_Install_App", <a><![CDATA[CAE_Elec_Install_App]]></a>.Value, 361, "APCTMP01",  "N", "N", False, False, "In Development", "", "C&E Electrical Install Estimator App", "", "", "",  "GLOBAL\H601424", "05/29/2025 17:08:38")
    AddProperty("2483", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "5/29/2025 3:43:02 PM")
    
      oSubpart = AddSubpart(243,"Control_Panels", <a><![CDATA[Control Panels]]></a>.Value, "MN", "", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (366, "CAE_Elec_Install_CP_Comps", "CAE Elec Install CP Comps")
      
      oConnection = AddConnection("My_PRD", <a><![CDATA[My PRD]]></a>.Value, "Connection to this line item's PRD", "108", "OO", 0, "","General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
    ...
    ctx = ContextId
        ...
        InitConnection("My_PRD", "88", "N","N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Connection to this line item's PRD", "In Development", "Y",151)
