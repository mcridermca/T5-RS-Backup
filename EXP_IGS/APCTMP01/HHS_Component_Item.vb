...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("HHS_Component_Item", <a><![CDATA[HHS Component Item]]></a>.Value, 353, "APCTMP01",  "N", "N", False, False, "In Development", "", "HHS Calculated Item", "", "", "",  "GLOBAL\H601424", "04/30/2025 18:10:46")
    ...
    AddProperty("2376", "Qty_Per_Hanger", <a><![CDATA[Qty Per Hanger]]></a>.Value, "Qty Per Hanger from DB", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/28/2025 4:40:16 PM")
    AddProperty("2462", "Qty_Total_Per_Hanger", <a><![CDATA[Qty Total Per Hanger]]></a>.Value, "Total Componenent Qty for this Calculation Group", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/28/2025 3:35:54 PM")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Qty_Per_Hanger", "2023", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/28/2025 4:40:16 PM", "Qty Per Hanger from DB", "In Development",  0,2811)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Qty_Total_Per_Hanger", "2106", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/28/2025 3:35:54 PM", "Total Componenent Qty for this Calculation Group", "In Development",  0,3271)
        End If
            If Incontext("-1", ctx) Then
...
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      ...
      Result = Me.Qty_Per_Hanger * Me.Qty_Of_Hangers
