...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("SFD_Salesforce_PRD_Product_Item", <a><![CDATA[SFD_Salesforce_PRD_Product_Item]]></a>.Value, 164, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "03/27/2025 11:06:08")
    ...
    AddProperty("1379", "PRD_Line_Input_Data", <a><![CDATA[PRD_Line_Input_Data]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/26/2025 9:53:56 PM")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("PRD_Line_Input_Data", "1078", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/26/2025 9:53:56 PM", "", "In Development",  0,1172)
        End If
            If Incontext("-1", ctx) Then
