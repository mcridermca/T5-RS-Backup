...
'$ GenerateDate: 06/12/2025 19:28:00
    ...
    InitPart("IGS_Tool_Instance_Mgr", <a><![CDATA[IGS_Tool_Instance_Mgr]]></a>.Value, 288, "APCTMP01",  "N", "N", False, False, "In Development", "", "Tool Manager. A Collection of tools  used in an IGS Project", "", "", "",  "GLOBAL\H601424", "05/29/2025 17:08:38")
    AddProperty("1278", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/26/2025 1:58:17 AM")
      ...
      oSubpart = AddSubpart(236,"Elec_Install_Estimator", <a><![CDATA[Elec Install Estimator]]></a>.Value, "FD", "Electrical Install Estimator", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (361, "CAE_Elec_Install_App", "CAE_Elec_Install_App")
      
      oSubpart = AddSubpart(237,"EQS_Estimator", <a><![CDATA[EQS Estimator]]></a>.Value, "FD", "Equipment Quote Estimator", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (362, "CAE_EQS_App", "CAE EQS App")
      ...
      oSubpart = AddSubpart(235,"Mech_Install_Estimator", <a><![CDATA[Mech Install Estimator]]></a>.Value, "FD", "Mechanical Install Estimator", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (359, "CAE_Mech_Install_App", "CAE Mech Install App")
      
      oSubpart = AddSubpart(241,"Netting_Estimator", <a><![CDATA[Netting Estimator]]></a>.Value, "FD", "Netting Estimator", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (365, "CAE_Netting_Estimator_App", "CAE Netting Estimator App")
      
      oSubpart = AddSubpart(242,"PM_Calc", <a><![CDATA[PM Calc]]></a>.Value, "FD", "Project  Management Estimation App", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (364, "CAE_PM_Calc_App", "CAE PM Calc App")
      
      oSubpart = AddSubpart(239,"PQI", <a><![CDATA[PQI]]></a>.Value, "FD", "Project Quote Information App", "General", 9999, "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM")
      
        oSubpart.AddVPF (363, "CAE_PQI_App", "CAE PQI App")
    ...
    ctx = ContextId
        ...
        InitSubpart("Elec_Install_Estimator", 174, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Electrical Install Estimator", "In Development", "Y",0,488,489)
        
          End If
        
            If Incontext("-1", ctx) Then
          
        InitSubpart("EQS_Estimator", 175, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Equipment Quote Estimator", "In Development", "Y",0,490,491)
        ...
        InitSubpart("Mech_Install_Estimator", 173, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Mechanical Install Estimator", "In Development", "Y",0,486,487)
        
          End If
        
            If Incontext("-1", ctx) Then
          
        InitSubpart("Netting_Estimator", 179, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Netting Estimator", "In Development", "Y",0,498,499)
        
          End If
        
            If Incontext("-1", ctx) Then
          
        InitSubpart("PM_Calc", 180, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Project  Management Estimation App", "In Development", "Y",0,500,501)
        
          End If
        
            If Incontext("-1", ctx) Then
          
        InitSubpart("PQI", 177, "N", "N", "N", 0, "-1", "", "GLOBAL\H601424", "5/29/2025 5:08:38 PM", "Project Quote Information App", "In Development", "Y",0,494,495)
    ...
    #Region " Formulas "
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:179; TYPE:PN
      
      '   END FORMULA; SUB ID:179; TYPE:PN
      Catch ex As Exception
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:179; TYPE:QF
      Result = 1
      '   END FORMULA; SUB ID:179; TYPE:QF
      Catch ex As Exception
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:179; TYPE:OP
      result = "CAE_Netting_Estimator_App"
      '   END FORMULA; SUB ID:179; TYPE:OP
      Catch ex As Exception
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:180; TYPE:PN
      
      '   END FORMULA; SUB ID:180; TYPE:PN
      Catch ex As Exception
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:180; TYPE:QF
      Result = 1
      '   END FORMULA; SUB ID:180; TYPE:QF
      Catch ex As Exception
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:180; TYPE:OP
      result = "CAE_PM_Calc_App"
      '   END FORMULA; SUB ID:180; TYPE:OP
      Catch ex As Exception
