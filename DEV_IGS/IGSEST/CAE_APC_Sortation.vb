...
'$ GenerateDate: 07/19/2025 13:01:33
    ...
    #Region " Properties, Subparts, Connections "
      ...
      End Property
          ...
          Public Property [Sorter_Types_dbKeys]() As Long
      Get
      Return Properties("Sorter_Types_dbKeys").Value
      End Get
      Set(ByVal Value As Long)
      Properties("Sorter_Types_dbKeys").CalculatedValue = Value
      End Set
      End Property
    ...
    AddProperty("10820", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 12:39:50 PM")
      ...
      AddValidValue("Sorter_Types_dbKeys")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sorter_Types_dbKeys", "10380", "", "", "Y", "","", 0, "-1", 1, "", "N","0",  "GLOBAL\H601424", "7/19/2025 12:51:11 PM", "", "In Development",  0,19420)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Sorter_Types_dbKeys_ValidValues", "10380", "-1", 19422)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      End Function
          ...
          '   Changes to this procedure may only be made within formula comment blocks.
          '*****************************************************************************
          Public Function Formula_Sorter_Types_dbKeys() As Long
          Dim Result as Long
      Dim ctx as Object
      Try
      ctx = this
      If Me.Properties("Sorter_Types_dbKeys").GetDebugState(Rulestream.Kernel.PropertySF.FormulaDebugTypes.VALUE_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:10380; TYPE:PF
      Result = Me.ValidValues("Sorter_Types_dbKeys").Count
      '   END FORMULA; PROP ID:10380; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_APC_Sortation.Formula_Sorter_Types_dbKeys", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_Sorter_Types_dbKeys_HIDE_CALCULATED_VALUE() as Boolean
      Return False
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_Sorter_Types_dbKeys_USERCHANGE() as Boolean
      Return False
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_Sorter_Types_dbKeys_ValidValues() as Rulestream.Kernel.ValidValues
      
      Dim Result as Rulestream.Kernel.ValidValues = Nothing 'HashTable
      Dim ctx as Object
      Try
      ctx = this
      If Me.Properties("Sorter_Types_dbKeys").GetDebugState(Rulestream.Kernel.PropertySF.FormulaDebugTypes.VALIDVALUES_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:10380; TYPE:VV
      Result = MakeValidValueKeyFromDatabase("[vw_APC_Sorter_Types]", "[PK_ID]", "[Model]", " ORDER BY [Model]")
      '   END FORMULA; PROP ID:10380; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_APC_Sortation.Formula_Sorter_Types_dbKeys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
