...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		Dim arr(73) as String 
		arr(0) = "439CAE_APC_MDRCAE_APC_MDR"
		arr(1) = "119APC_Setup (APCTMP01)APC_Setup"
		arr(2) = "376IGS_Project_Top_AppIGS_Project_Top_App"
		arr(3) = "437CAE_App_Calc_MetricsCAE_App_Calc_Metrics"
		arr(4) = "438CAE_MDR_SorterCAE_MDR_Sorter"
		arr(5) = "411CAE_App_CalcCAE_App_Calc"
		arr(6) = "389CAE_Conveyor_CostingCAE_Conveyor_Costing"
		arr(7) = "360CAE_Mech_Install_App (APCTMP01)CAE Mech Install App"
		arr(8) = "432CAE_Sourcing_InputsCAE_Sourcing_Inputs"
		arr(9) = "431CAE_Sourcing_InputCAE_Sourcing_Input"
		arr(10) = "163SFD_Salesforce_PRD_Header_Mock (APCTMP01)SFD_Salesforce_PRD_Header_Mock"
		arr(11) = "377IGS_Tool_Instance_MgrIGS_Tool_Instance_Mgr"
		arr(12) = "436APC_Setup_Sort_Equip_OptionAPC_Setup_Sort_Equip_Option"
		arr(13) = "375IGS_Proposal_DataIGS_Proposal_Data"
		arr(14) = "399CAE_Mech_Install_CP_CompCAE_Mech_Install_CP_Comp"
		arr(15) = "398CAE_Shuttle_MechCAE_Shuttle_Mech"
		arr(16) = "392CAE_Air_Piping_Control_PanelCAE_Air_Piping_Control_Panel"
		arr(17) = "435CAE_Mech_Install_Data_Market_Labor_RatesCAE_Mech_Install_Data_Market_Labor_Rates"
		arr(18) = "382CAE_Mech_Install_MetricsCAE_Mech_Install_Metrics"
		arr(19) = "434Mech_Install_Data_Market_Labor_RatesMech_Install_Data_Market_Labor_Rates"
		arr(20) = "433Data_Market_Labor_RateData_Market_Labor_Rate"
		arr(21) = "427CAE_Misc_ConstantCAE_Misc_Constant"
		arr(22) = "409CAE_ChutesCAE_Chutes"
		arr(23) = "430CAE_ChuteCAE_Chute"
		arr(24) = "401CAE_TTCB_Costing_MechCAE_TTCB_Costing_Mech"
		arr(25) = "422CAE_App_Calc_Print_And_Apply_Theoretical_MaxCAE_App_Calc_Print_And_Apply_Theoretical_Max"
		arr(26) = "428CAE_MEI_Equipment_RentalsCAE_MEI_Equipment_Rentals"
		arr(27) = "416CAE_App_Calc_Print_And_ApplyCAE_App_Calc_Print_And_Apply"
		arr(28) = "417APC_Scan_Configuration (APCTMP01)APC_Scan_Configuration"
		arr(29) = "333HHS_HeaderHanger_Calc (APCTMP01)Header Hanger Calculator"
		arr(30) = "418APC_Scan_Panel_Configuration (APCTMP01)APC_Scan_Panel_Configuration"
		arr(31) = "426PRD_Output_Test_01_LinePRD_Output_Test_01_Line"
		arr(32) = "425PRD_Output_Test_01PRD_Output_Test_01"
		arr(33) = "371SFD_sm_PRD_Base_Item (APCTMP01)SubMst PRD Base Item"
		arr(34) = "424CAE_MEI_HHS_Hanger_TypesCAE_MEI_HHS_Hanger_Types"
		arr(35) = "336HHS_Output_Header (APCTMP01)HHS Output Header"
		arr(36) = "339HHS_Grouping_Matrix_Controller (APCTMP01)HHS Grouping Matrix Controller"
		arr(37) = "419CAE_EHS350_DataCAE_EHS350_Data"
		arr(38) = "122APC_Induction (APCTMP01)APC_Induction"
		arr(39) = "120APC_Sortation (APCTMP01)APC_Sortation"
		arr(40) = "407HHS_BOM_Report_Header (APCTMP01)HHS_BOM_Report_Header"
		arr(41) = "353HHS_Component_Item (APCTMP01)HHS Component Item"
		arr(42) = "356HHS_Hanger_Item (APCTMP01)HHS_Hanger_Item"
		arr(43) = "413HHS_Sway_Bracing (APCTMP01)HHS_Sway_Bracing"
		arr(44) = "340sm_HHS_Group_Calculator (APCTMP01)sm HHS Group Calculator"
		arr(45) = "358HHS_BOM_Item (APCTMP01)HHS BOM Item"
		arr(46) = "357sm_Generic_BOM_Item (APCTMP01)sm Generic BOM Item"
		arr(47) = "334HHS_DWGXLSX_Importer (APCTMP01)Header Hanger DWG Excel Importer"
		arr(48) = "354HHS_Component_Item_DB_Data (APCTMP01)HHS_Component_Item_DB_Data"
		arr(49) = "414HHS_Sway_Bracing_DB_Data (APCTMP01)HHS_Sway_Bracing_DB_Data"
		arr(50) = "415CAE_MEI_Pallet_Conveyor (APCTMP01)CAE_MEI_Pallet_Conveyor"
		arr(51) = "384CAE_Mech_Install_Conveyor_HoursCAE Mech Install Conveyor Hours"
		arr(52) = "410CAE_MEI_Package_Flow_Rates (APCTMP01)CAE_MEI_Package_Flow_Rates"
		arr(53) = "412CAE_Print_And_ApplyCAE_Print_And_Apply"
		arr(54) = "408HHS_BOM_Report_Line (APCTMP01)HHS_BOM_Report_Line"
		arr(55) = "338HHS_Output_Line_DB_Data (APCTMP01)HHS Output Line DB Data"
		arr(56) = "355HHS_Hanger_Item_DB_Data (APCTMP01)HHS Hanger Item DB Data"
		arr(57) = "394CAE_Conveyor_Costing_ElecCAE_Conveyor_Costing_Elec"
		arr(58) = "365CAE_Elec_Install_CP_Comps (APCTMP01)CAE Elec Install CP Comps"
		arr(59) = "361CAE_Elec_Install_App (APCTMP01)CAE_Elec_Install_App"
		arr(60) = "402CAE_TTCB_Costing_ElecCAE_TTCB_Costing_Elec"
		arr(61) = "397CAE_Shuttle_ElecCAE_Shuttle_Elec"
		arr(62) = "396CAE_Power_Feed_Control_PanelCAE_Power_Feed_Control_Panel"
		arr(63) = "395CAE_Power_FeedsCAE_Power_Feeds"
		arr(64) = "393CAE_Conveyor_Installs_ElecCAE_Conveyor_Installs_Elec"
		arr(65) = "387CAE_Control_Panels_Structures_PlatformsCAE_Control_Panels_Structures_Platforms"
		arr(66) = "388tmp_Metrics_Lookup_Sampletmp_Metrics_Lookup_Sample"
		arr(67) = "385CAE_Structures_PlatformCAE_Structures_Platform"
		arr(68) = "386CAE_Structures_PlatformsCAE_Structures_Platforms"
		arr(69) = "381CAE_Elec_Install_MetricsCAE_Elec_Install_Metrics"
		arr(70) = "374IGS_OpportunityIGS_Opportunity"
		arr(71) = "164SFD_Salesforce_PRD_Product_Item (APCTMP01)SFD_Salesforce_PRD_Product_Item"
		arr(72) = "335HHS_DWGXLSX_Import_Line (APCTMP01)HHS Import Line"
		arr(73) = "337HHS_Output_Line (APCTMP01)HHS Output Line"
