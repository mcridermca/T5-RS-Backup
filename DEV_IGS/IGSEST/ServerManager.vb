...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		Dim arr(76) as String 
		arr(0) = "439CAE_APC_MDRCAE_APC_MDR"
		arr(1) = "389CAE_Conveyor_CostingCAE_Conveyor_Costing"
		arr(2) = "392CAE_Air_Piping_Control_PanelCAE_Air_Piping_Control_Panel"
		arr(3) = "398CAE_Shuttle_MechCAE_Shuttle_Mech"
		arr(4) = "376IGS_Project_Top_AppIGS_Project_Top_App"
		arr(5) = "360CAE_Mech_Install_App (APCTMP01)CAE Mech Install App"
		arr(6) = "428CAE_MEI_Equipment_RentalsCAE_MEI_Equipment_Rentals"
		arr(7) = "442CAE_APC_SortationCAE_APC_Sortation"
		arr(8) = "443CAE_APC_Sorter_App_Details (APCTMP01)CAE_APC_Sorter_App_Details"
		arr(9) = "444CAE_APC_Sorter_App_Details_dbInfo (APCTMP01)CAE_APC_Sorter_App_Details_dbInfo"
		arr(10) = "382CAE_Mech_Install_MetricsCAE_Mech_Install_Metrics"
		arr(11) = "447CAE_MEI_Per_Diem_RangesCAE_MEI_Per_Diem_Ranges"
		arr(12) = "401CAE_TTCB_Costing_MechCAE_TTCB_Costing_Mech"
		arr(13) = "119APC_Setup (APCTMP01)APC_Setup"
		arr(14) = "418APC_Scan_Panel_Configuration (APCTMP01)APC_Scan_Panel_Configuration"
		arr(15) = "417APC_Scan_Configuration (APCTMP01)APC_Scan_Configuration"
		arr(16) = "377IGS_Tool_Instance_MgrIGS_Tool_Instance_Mgr"
		arr(17) = "411CAE_App_CalcCAE_App_Calc"
		arr(18) = "415CAE_MEI_Pallet_Conveyor (APCTMP01)CAE_MEI_Pallet_Conveyor"
		arr(19) = "427CAE_Misc_ConstantCAE_Misc_Constant"
		arr(20) = "410CAE_MEI_Package_Flow_Rates (APCTMP01)CAE_MEI_Package_Flow_Rates"
		arr(21) = "399CAE_Mech_Install_CP_CompCAE_Mech_Install_CP_Comp"
		arr(22) = "437CAE_App_Calc_MetricsCAE_App_Calc_Metrics"
		arr(23) = "438CAE_MDR_SorterCAE_MDR_Sorter"
		arr(24) = "432CAE_Sourcing_InputsCAE_Sourcing_Inputs"
		arr(25) = "431CAE_Sourcing_InputCAE_Sourcing_Input"
		arr(26) = "163SFD_Salesforce_PRD_Header_Mock (APCTMP01)SFD_Salesforce_PRD_Header_Mock"
		arr(27) = "436APC_Setup_Sort_Equip_OptionAPC_Setup_Sort_Equip_Option"
		arr(28) = "375IGS_Proposal_DataIGS_Proposal_Data"
		arr(29) = "435CAE_Mech_Install_Data_Market_Labor_RatesCAE_Mech_Install_Data_Market_Labor_Rates"
		arr(30) = "434Mech_Install_Data_Market_Labor_RatesMech_Install_Data_Market_Labor_Rates"
		arr(31) = "433Data_Market_Labor_RateData_Market_Labor_Rate"
		arr(32) = "409CAE_ChutesCAE_Chutes"
		arr(33) = "430CAE_ChuteCAE_Chute"
		arr(34) = "422CAE_App_Calc_Print_And_Apply_Theoretical_MaxCAE_App_Calc_Print_And_Apply_Theoretical_Max"
		arr(35) = "416CAE_App_Calc_Print_And_ApplyCAE_App_Calc_Print_And_Apply"
		arr(36) = "333HHS_HeaderHanger_Calc (APCTMP01)Header Hanger Calculator"
		arr(37) = "426PRD_Output_Test_01_LinePRD_Output_Test_01_Line"
		arr(38) = "425PRD_Output_Test_01PRD_Output_Test_01"
		arr(39) = "371SFD_sm_PRD_Base_Item (APCTMP01)SubMst PRD Base Item"
		arr(40) = "424CAE_MEI_HHS_Hanger_TypesCAE_MEI_HHS_Hanger_Types"
		arr(41) = "336HHS_Output_Header (APCTMP01)HHS Output Header"
		arr(42) = "339HHS_Grouping_Matrix_Controller (APCTMP01)HHS Grouping Matrix Controller"
		arr(43) = "419CAE_EHS350_DataCAE_EHS350_Data"
		arr(44) = "122APC_Induction (APCTMP01)APC_Induction"
		arr(45) = "407HHS_BOM_Report_Header (APCTMP01)HHS_BOM_Report_Header"
		arr(46) = "353HHS_Component_Item (APCTMP01)HHS Component Item"
		arr(47) = "356HHS_Hanger_Item (APCTMP01)HHS_Hanger_Item"
		arr(48) = "413HHS_Sway_Bracing (APCTMP01)HHS_Sway_Bracing"
		arr(49) = "340sm_HHS_Group_Calculator (APCTMP01)sm HHS Group Calculator"
		arr(50) = "358HHS_BOM_Item (APCTMP01)HHS BOM Item"
		arr(51) = "357sm_Generic_BOM_Item (APCTMP01)sm Generic BOM Item"
		arr(52) = "334HHS_DWGXLSX_Importer (APCTMP01)Header Hanger DWG Excel Importer"
		arr(53) = "354HHS_Component_Item_DB_Data (APCTMP01)HHS_Component_Item_DB_Data"
		arr(54) = "414HHS_Sway_Bracing_DB_Data (APCTMP01)HHS_Sway_Bracing_DB_Data"
		arr(55) = "384CAE_Mech_Install_Conveyor_HoursCAE Mech Install Conveyor Hours"
		arr(56) = "412CAE_Print_And_ApplyCAE_Print_And_Apply"
		arr(57) = "408HHS_BOM_Report_Line (APCTMP01)HHS_BOM_Report_Line"
		arr(58) = "338HHS_Output_Line_DB_Data (APCTMP01)HHS Output Line DB Data"
		arr(59) = "355HHS_Hanger_Item_DB_Data (APCTMP01)HHS Hanger Item DB Data"
		arr(60) = "394CAE_Conveyor_Costing_ElecCAE_Conveyor_Costing_Elec"
		arr(61) = "365CAE_Elec_Install_CP_Comps (APCTMP01)CAE Elec Install CP Comps"
		arr(62) = "361CAE_Elec_Install_App (APCTMP01)CAE_Elec_Install_App"
		arr(63) = "402CAE_TTCB_Costing_ElecCAE_TTCB_Costing_Elec"
		arr(64) = "397CAE_Shuttle_ElecCAE_Shuttle_Elec"
		arr(65) = "396CAE_Power_Feed_Control_PanelCAE_Power_Feed_Control_Panel"
		arr(66) = "395CAE_Power_FeedsCAE_Power_Feeds"
		arr(67) = "393CAE_Conveyor_Installs_ElecCAE_Conveyor_Installs_Elec"
		arr(68) = "387CAE_Control_Panels_Structures_PlatformsCAE_Control_Panels_Structures_Platforms"
		arr(69) = "388tmp_Metrics_Lookup_Sampletmp_Metrics_Lookup_Sample"
		arr(70) = "385CAE_Structures_PlatformCAE_Structures_Platform"
		arr(71) = "386CAE_Structures_PlatformsCAE_Structures_Platforms"
		arr(72) = "381CAE_Elec_Install_MetricsCAE_Elec_Install_Metrics"
		arr(73) = "374IGS_OpportunityIGS_Opportunity"
		arr(74) = "164SFD_Salesforce_PRD_Product_Item (APCTMP01)SFD_Salesforce_PRD_Product_Item"
		arr(75) = "335HHS_DWGXLSX_Import_Line (APCTMP01)HHS Import Line"
		arr(76) = "337HHS_Output_Line (APCTMP01)HHS Output Line"
