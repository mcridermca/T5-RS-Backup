...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		Dim arr(70) as String 
		arr(0) = "436APC_Setup_Sort_Equip_OptionAPC_Setup_Sort_Equip_Option"
		arr(1) = "376IGS_Project_Top_AppIGS_Project_Top_App"
		arr(2) = "119APC_Setup (APCTMP01)APC_Setup"
		arr(3) = "163SFD_Salesforce_PRD_Header_Mock (APCTMP01)SFD_Salesforce_PRD_Header_Mock"
		arr(4) = "375IGS_Proposal_DataIGS_Proposal_Data"
		arr(5) = "360CAE_Mech_Install_App (APCTMP01)CAE Mech Install App"
		arr(6) = "399CAE_Mech_Install_CP_CompCAE_Mech_Install_CP_Comp"
		arr(7) = "398CAE_Shuttle_MechCAE_Shuttle_Mech"
		arr(8) = "392CAE_Air_Piping_Control_PanelCAE_Air_Piping_Control_Panel"
		arr(9) = "435CAE_Mech_Install_Data_Market_Labor_RatesCAE_Mech_Install_Data_Market_Labor_Rates"
		arr(10) = "382CAE_Mech_Install_MetricsCAE_Mech_Install_Metrics"
		arr(11) = "434Mech_Install_Data_Market_Labor_RatesMech_Install_Data_Market_Labor_Rates"
		arr(12) = "433Data_Market_Labor_RateData_Market_Labor_Rate"
		arr(13) = "427CAE_Misc_ConstantCAE_Misc_Constant"
		arr(14) = "409CAE_ChutesCAE_Chutes"
		arr(15) = "389CAE_Conveyor_CostingCAE_Conveyor_Costing"
		arr(16) = "377IGS_Tool_Instance_MgrIGS_Tool_Instance_Mgr"
		arr(17) = "432CAE_Sourcing_InputsCAE_Sourcing_Inputs"
		arr(18) = "431CAE_Sourcing_InputCAE_Sourcing_Input"
		arr(19) = "430CAE_ChuteCAE_Chute"
		arr(20) = "401CAE_TTCB_Costing_MechCAE_TTCB_Costing_Mech"
		arr(21) = "422CAE_App_Calc_Print_And_Apply_Theoretical_MaxCAE_App_Calc_Print_And_Apply_Theoretical_Max"
		arr(22) = "428CAE_MEI_Equipment_RentalsCAE_MEI_Equipment_Rentals"
		arr(23) = "416CAE_App_Calc_Print_And_ApplyCAE_App_Calc_Print_And_Apply"
		arr(24) = "417APC_Scan_Configuration (APCTMP01)APC_Scan_Configuration"
		arr(25) = "333HHS_HeaderHanger_Calc (APCTMP01)Header Hanger Calculator"
		arr(26) = "411CAE_App_CalcCAE_App_Calc"
		arr(27) = "418APC_Scan_Panel_Configuration (APCTMP01)APC_Scan_Panel_Configuration"
		arr(28) = "426PRD_Output_Test_01_LinePRD_Output_Test_01_Line"
		arr(29) = "425PRD_Output_Test_01PRD_Output_Test_01"
		arr(30) = "371SFD_sm_PRD_Base_Item (APCTMP01)SubMst PRD Base Item"
		arr(31) = "424CAE_MEI_HHS_Hanger_TypesCAE_MEI_HHS_Hanger_Types"
		arr(32) = "336HHS_Output_Header (APCTMP01)HHS Output Header"
		arr(33) = "339HHS_Grouping_Matrix_Controller (APCTMP01)HHS Grouping Matrix Controller"
		arr(34) = "419CAE_EHS350_DataCAE_EHS350_Data"
		arr(35) = "122APC_Induction (APCTMP01)APC_Induction"
		arr(36) = "120APC_Sortation (APCTMP01)APC_Sortation"
		arr(37) = "407HHS_BOM_Report_Header (APCTMP01)HHS_BOM_Report_Header"
		arr(38) = "353HHS_Component_Item (APCTMP01)HHS Component Item"
		arr(39) = "356HHS_Hanger_Item (APCTMP01)HHS_Hanger_Item"
		arr(40) = "413HHS_Sway_Bracing (APCTMP01)HHS_Sway_Bracing"
		arr(41) = "340sm_HHS_Group_Calculator (APCTMP01)sm HHS Group Calculator"
		arr(42) = "358HHS_BOM_Item (APCTMP01)HHS BOM Item"
		arr(43) = "357sm_Generic_BOM_Item (APCTMP01)sm Generic BOM Item"
		arr(44) = "334HHS_DWGXLSX_Importer (APCTMP01)Header Hanger DWG Excel Importer"
		arr(45) = "354HHS_Component_Item_DB_Data (APCTMP01)HHS_Component_Item_DB_Data"
		arr(46) = "414HHS_Sway_Bracing_DB_Data (APCTMP01)HHS_Sway_Bracing_DB_Data"
		arr(47) = "415CAE_MEI_Pallet_Conveyor (APCTMP01)CAE_MEI_Pallet_Conveyor"
		arr(48) = "384CAE_Mech_Install_Conveyor_HoursCAE Mech Install Conveyor Hours"
		arr(49) = "410CAE_MEI_Package_Flow_Rates (APCTMP01)CAE_MEI_Package_Flow_Rates"
		arr(50) = "412CAE_Print_And_ApplyCAE_Print_And_Apply"
		arr(51) = "408HHS_BOM_Report_Line (APCTMP01)HHS_BOM_Report_Line"
		arr(52) = "338HHS_Output_Line_DB_Data (APCTMP01)HHS Output Line DB Data"
		arr(53) = "355HHS_Hanger_Item_DB_Data (APCTMP01)HHS Hanger Item DB Data"
		arr(54) = "394CAE_Conveyor_Costing_ElecCAE_Conveyor_Costing_Elec"
		arr(55) = "365CAE_Elec_Install_CP_Comps (APCTMP01)CAE Elec Install CP Comps"
		arr(56) = "361CAE_Elec_Install_App (APCTMP01)CAE_Elec_Install_App"
		arr(57) = "402CAE_TTCB_Costing_ElecCAE_TTCB_Costing_Elec"
		arr(58) = "397CAE_Shuttle_ElecCAE_Shuttle_Elec"
		arr(59) = "396CAE_Power_Feed_Control_PanelCAE_Power_Feed_Control_Panel"
		arr(60) = "395CAE_Power_FeedsCAE_Power_Feeds"
		arr(61) = "393CAE_Conveyor_Installs_ElecCAE_Conveyor_Installs_Elec"
		arr(62) = "387CAE_Control_Panels_Structures_PlatformsCAE_Control_Panels_Structures_Platforms"
		arr(63) = "388tmp_Metrics_Lookup_Sampletmp_Metrics_Lookup_Sample"
		arr(64) = "385CAE_Structures_PlatformCAE_Structures_Platform"
		arr(65) = "386CAE_Structures_PlatformsCAE_Structures_Platforms"
		arr(66) = "381CAE_Elec_Install_MetricsCAE_Elec_Install_Metrics"
		arr(67) = "374IGS_OpportunityIGS_Opportunity"
		arr(68) = "164SFD_Salesforce_PRD_Product_Item (APCTMP01)SFD_Salesforce_PRD_Product_Item"
		arr(69) = "335HHS_DWGXLSX_Import_Line (APCTMP01)HHS Import Line"
		arr(70) = "337HHS_Output_Line (APCTMP01)HHS Output Line"
