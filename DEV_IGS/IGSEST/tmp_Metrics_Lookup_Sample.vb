...
'$ GenerateDate: 07/09/2025 14:47:24
    ...
    Public Class [tmp_Metrics_Lookup_Sample]
    ...
    Private this as tmp_Metrics_Lookup_Sample = me
    ...
    InitPart("tmp_Metrics_Lookup_Sample", <a><![CDATA[tmp_Metrics_Lookup_Sample]]></a>.Value, 388, "IGSEST",  "", "", True, True, "In Development", "", "Sample / Test App To Demonstrate How Metric Lookup works", "", "", "",  "GLOBAL\H601424", "06/27/2025 16:22:51")
    AddProperty("5586", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/27/2025 4:18:42 PM")
    
      oSubpart = AddSubpart(274,"Mech_Install_Metrics", <a><![CDATA[Mech_Install_Metrics]]></a>.Value, "FD", "", "Database Lookup", 9999, "", "GLOBAL\H601424", "6/27/2025 4:22:51 PM")
    ...
    End Sub
        ...
        oProcessStep = AddProcessStep(77, "Step 1", "This process step was created automatically by RuleStream.", 1, 52, 1, 1, 50, 50)
        oProcessStep.AddPath("tmp_Metrics_Lookup_Sample")
        oProcessStep.AddFilter(1, 388, "System", 0, "PartNumber", 0)
    ...
    ctx = ContextId
        ...
        InitSubpart("Mech_Install_Metrics", 202, "", "", "Y", 0, "-1", "", "GLOBAL\H601424", "6/27/2025 4:22:45 PM", "", "In Development", "N",0,558,556)
    ...
    #Region " Formulas "
      ...
      Try
      '   BEGIN FORMULA; PROC ID:77; TYPE:ST
      result = STATUS_ENABLED
      '   END FORMULA; PROC ID:77; TYPE:ST
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " tmp_Metrics_Lookup_Sample.Process_DefaultProcess_Step_1_STATUS", ex.Message)
      ...
      Dim Result as String = ""
      Try
      '   BEGIN FORMULA; PROC ID:77; TYPE:CO
      result = ""
      '   END FORMULA; PROC ID:77; TYPE:CO
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " tmp_Metrics_Lookup_Sample.Process_DefaultProcess_Step_1_COMMENT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:202; TYPE:PN
      
      '   END FORMULA; SUB ID:202; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " tmp_Metrics_Lookup_Sample.Formula_Mech_Install_Metrics_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:202; TYPE:QF
      result = 1
      '   END FORMULA; SUB ID:202; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " tmp_Metrics_Lookup_Sample.Formula_Mech_Install_Metrics_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:202; TYPE:OP
      Result = "CAE_Mech_Install_Metrics"
      '   END FORMULA; SUB ID:202; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " tmp_Metrics_Lookup_Sample.Formula_Mech_Install_Metrics_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
