...
'$ GenerateDate: 07/12/2025 13:20:28
    ...
    InitPart("HHS_Group_Calculator_E", <a><![CDATA[HHS Group Calculator E]]></a>.Value, 345, "APCTMP01",  "N", "N", False, False, "In Development", "", "HHS Group E Calculator", "", "", "",  "GLOBAL\H601424", "07/11/2025 12:09:32")
    AddProperty("2394", "Component_Item_Keys", <a><![CDATA[Component Item Keys]]></a>.Value, "DBLookup Keys for SubPart Components", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/10/2025 7:56:51 PM")
    ...
    AddProperty("9775", "Sway_Bracing_Keys", <a><![CDATA[Sway_Bracing_Keys]]></a>.Value, "DBLookup Keys for SubPart Sway Bracing", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 12:09:32 PM")
    ...
    AddProperty("2247", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/23/2025 12:08:39 PM")
      ...
      oSubpart = AddSubpart(321,"Sway_Bracing_Items", <a><![CDATA[Sway_Bracing_Items]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "7/10/2025 3:02:37 AM")
      ...
      oConnection = AddConnection("My_HHS_Items", <a><![CDATA[My_HHS_Items]]></a>.Value, "HHS Items Specific To Me", "147", "OM", 0, "","General", 9999, "", "GLOBAL\H601424", "7/10/2025 5:04:53 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Component_Item_Keys", "2040", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/10/2025 7:56:51 PM", "DBLookup Keys for SubPart Components", "In Development",  0,3349)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sway_Bracing_Keys", "9350", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 12:09:23 PM", "DBLookup Keys for SubPart Hangers", "In Development",  0,15885)
        End If
            If Incontext("-1", ctx) Then
    ...
    ctx = ContextId
        ...
        InitValidValue("Component_Item_Keys_ValidValues", "2040", "-1", 16255)
        End If
            If Incontext("-1", ctx) Then
        ...
        InitValidValue("Sway_Bracing_Keys_ValidValues", "9350", "-1", 16389)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Sway_Bracing_Items", 248, "", "", "Y", 0, "-1", "", "GLOBAL\H601424", "7/10/2025 3:02:37 AM", "", "In Development", "N",0,673,687)
    ...
    ctx = ContextId
        ...
        InitConnection("My_HHS_Items", "127", "","", "Y", 0, "-1", "", "GLOBAL\H601424", "7/10/2025 5:04:53 PM", "", "In Development", "Y",235)
    ...
    #Region " Formulas "
      ...
      ctx = this
        ...
        '   BEGIN FORMULA; CON ID:127; TYPE:PF
...
For Each p As part In Me.Parent.My_HHS_Items
	...
	End If
Next P
        '   END FORMULA; CON ID:127; TYPE:PF
...
End If
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9350; TYPE:PF
      Result = 0
If Me.Valid Then
	Result = Me.ValidValues("Sway_Bracing_Keys").Count
End If
      '   END FORMULA; PROP ID:9350; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Group_Calculator_E.Formula_Sway_Bracing_Keys", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9350; TYPE:VV
      Result = Nothing
...
End If
      '   END FORMULA; PROP ID:9350; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Group_Calculator_E.Formula_Sway_Bracing_Keys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   BEGIN FORMULA; SUB ID:248; TYPE:PN
      
      '   END FORMULA; SUB ID:248; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Group_Calculator_E.Formula_Sway_Bracing_Items_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:248; TYPE:QF
      Result = Me.Sway_Bracing_Keys
      '   END FORMULA; SUB ID:248; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Group_Calculator_E.Formula_Sway_Bracing_Items_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:248; TYPE:OP
      result = "HHS_Sway_Bracing"
      '   END FORMULA; SUB ID:248; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Group_Calculator_E.Formula_Sway_Bracing_Items_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
