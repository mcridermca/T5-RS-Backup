...
'$ PartFamily: CAE_ME_System_Hours
    ...
    Public Class [CAE_ME_System_Hours]
    ...
    Private this as CAE_ME_System_Hours = me
    ...
    InitPart("CAE_ME_System_Hours", <a><![CDATA[CAE_ME_System_Hours]]></a>.Value, 306, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "03/28/2025 05:13:01")
    AddProperty("1511", "Approved_By", <a><![CDATA[Approved By]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1512", "Approved_Date", <a><![CDATA[Approved Date]]></a>.Value, "", "Date","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1487", "Customer_Name", <a><![CDATA[Customer Name]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1515", "Escalated_Equipment_USD", <a><![CDATA[Escalated Equipment USD]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1489", "Estimated_By", <a><![CDATA[Estimated By]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1488", "Facility_Location", <a><![CDATA[Facility Location]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1517", "Mexico_Split_PCNT", <a><![CDATA[Mexico Split PCNT]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1513", "Proposal_No", <a><![CDATA[Proposal No]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1514", "Revision_No", <a><![CDATA[Revision No]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1516", "US_Split_PCNT", <a><![CDATA[US Split PCNT]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:13:01 AM")
    AddProperty("1477", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 4:50:10 AM")
    ...
    ctx = ContextId
          ...
          InitProperty("Approved_By", "1205", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1295)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Approved_Date", "1206", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1296)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Customer_Name", "1181", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1271)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Escalated_Equipment_USD", "1209", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1299)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Estimated_By", "1183", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1273)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Facility_Location", "1182", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1272)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Mexico_Split_PCNT", "1211", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1301)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Proposal_No", "1207", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1297)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Revision_No", "1208", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1298)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("US_Split_PCNT", "1210", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:13:01 AM", "", "In Development",  0,1300)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Approved_By", ex.Message)
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Approved_Date", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Customer_Name", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Escalated_Equipment_USD", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Estimated_By", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Facility_Location", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Mexico_Split_PCNT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Proposal_No", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_Revision_No", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_System_Hours.Formula_US_Split_PCNT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
