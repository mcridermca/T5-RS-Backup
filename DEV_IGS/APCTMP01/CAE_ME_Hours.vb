...
'$ GenerateDate: 07/12/2025 14:40:53
    ...
    Private this as CAE_ME_Hours = me
    ...
    InitPart("CAE_ME_Hours", <a><![CDATA[CAE_ME_Hours]]></a>.Value, 304, "APCTMP01",  "N", "N", False, False, "In Development", "", "Concept And Estimating Mech Engineering Hours Estimator", "", "", "",  "GLOBAL\H601424", "03/28/2025 05:03:36")
    AddProperty("1497", "Approved_By", <a><![CDATA[Approved By]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1498", "Approved_Date", <a><![CDATA[Approved Date]]></a>.Value, "", "Date","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1481", "Customer_Name", <a><![CDATA[Customer Name]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1501", "Escalated_Equipment_USD", <a><![CDATA[Escalated Equipment USD]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1483", "Estimated_By", <a><![CDATA[Estimated By]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1482", "Facility_Location", <a><![CDATA[Facility Location]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1503", "Mexico_Split_PCNT", <a><![CDATA[Mexico Split PCNT]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1499", "Proposal_No", <a><![CDATA[Proposal No]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1500", "Revision_No", <a><![CDATA[Revision No]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1502", "US_Split_PCNT", <a><![CDATA[US Split PCNT]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 5:03:36 AM")
    AddProperty("1475", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/28/2025 4:50:10 AM")
    ...
    ctx = ContextId
          ...
          InitProperty("Approved_By", "1191", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1281)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Approved_Date", "1192", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1282)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Customer_Name", "1175", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1265)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Escalated_Equipment_USD", "1195", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1285)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Estimated_By", "1177", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1267)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Facility_Location", "1176", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1266)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Mexico_Split_PCNT", "1197", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1287)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Proposal_No", "1193", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1283)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Revision_No", "1194", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1284)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("US_Split_PCNT", "1196", "", "", "N", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "3/28/2025 5:03:36 AM", "", "In Development",  0,1286)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1191; TYPE:PF
      result = Me.Parent.Approved_By
      '   END FORMULA; PROP ID:1191; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Approved_By", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1192; TYPE:PF
      result = Me.Parent.Approved_Date
      '   END FORMULA; PROP ID:1192; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Approved_Date", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Customer_Name", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1195; TYPE:PF
      result = Me.Parent.Escalated_Equipment_USD
      '   END FORMULA; PROP ID:1195; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Escalated_Equipment_USD", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Estimated_By", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Facility_Location", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1197; TYPE:PF
      result = Me.Parent.Mexico_Split_PCNT
      '   END FORMULA; PROP ID:1197; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Mexico_Split_PCNT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1193; TYPE:PF
      result = Me.Parent.Proposal_No
      '   END FORMULA; PROP ID:1193; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Proposal_No", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1194; TYPE:PF
      result = Me.Parent.Revision_No
      '   END FORMULA; PROP ID:1194; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_Revision_No", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1196; TYPE:PF
      result = Me.Parent.US_Split_PCNT
      '   END FORMULA; PROP ID:1196; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " CAE_ME_Hours.Formula_US_Split_PCNT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
