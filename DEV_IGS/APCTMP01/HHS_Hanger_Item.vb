...
'$ GenerateDate: 07/12/2025 13:20:28
    ...
    InitPart("HHS_Hanger_Item", <a><![CDATA[HHS_Hanger_Item]]></a>.Value, 356, "APCTMP01",  "N", "N", False, False, "In Development", "", "HHS Calculated Item (Hanger)", "", "", "",  "GLOBAL\H601424", "07/11/2025 12:24:46")
    ...
    AddProperty("9885", "ExtCost", <a><![CDATA[ExtCost]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/10/2025 8:12:59 PM")
    AddProperty("9897", "ExtCost_Formatted", <a><![CDATA[ExtCost_Formatted]]></a>.Value, "Extended Cost, Formatted for Display, Grids", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 12:24:46 PM")
    ...
    AddProperty("9502", "Location", <a><![CDATA[Location]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 5:12:42 PM")
    ...
    AddProperty("9899", "Qty_Total_Per_Hanger_Formatted", <a><![CDATA[Qty_Total_Per_Hanger_Formatted]]></a>.Value, "Total Componenent Qty for this Calculation Group", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 12:19:07 PM")
    ...
    AddProperty("8098", "Sort_Order_1_Dbg_Grouping", <a><![CDATA[Sort_Order_1_Dbg_Grouping]]></a>.Value, "Default Sort Order for Grids , Lookups, Forms", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/3/2025 1:57:59 PM")
    ...
    ctx = ContextId
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("ExtCost", "9469", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/10/2025 8:12:59 PM", "", "In Development",  0,16269)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("ExtCost_Formatted", "9481", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 12:24:46 PM", "", "In Development",  0,16407)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Location", "9082", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 5:12:42 PM", "", "In Development",  0,15173)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Qty_Total_Per_Hanger_Formatted", "9483", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 12:19:02 PM", "Total Componenent Qty for this Calculation Group", "In Development",  0,16404)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sort_Order_1_Dbg_Grouping", "7696", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/3/2025 1:57:59 PM", "Default Sort Order for Grids , Lookups, Forms", "In Development",  0,12000)
        End If
            If Incontext("-1", ctx) Then
...
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9469; TYPE:PF
      Result = Me.Qty_Per_Hanger * Me.UnitCost
      '   END FORMULA; PROP ID:9469; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Hanger_Item.Formula_ExtCost", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9481; TYPE:PF
      Result = rounding(.01, Me.ExtCost)
      '   END FORMULA; PROP ID:9481; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Hanger_Item.Formula_ExtCost_Formatted", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9082; TYPE:PF
      Dim MyPropertyName = Me.CurrentProperty.Name
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      '   END FORMULA; PROP ID:9082; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Hanger_Item.Formula_Location", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9483; TYPE:PF
      Result = 0
Result = Me.Qty_Total_Per_Hanger
      '   END FORMULA; PROP ID:9483; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Hanger_Item.Formula_Qty_Total_Per_Hanger_Formatted", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:7696; TYPE:PF
      Dim MyPropertyName = Me.CurrentProperty.Name
Result = Me.DB_Data(1).Properties(MyPropertyName).DisplayValue
      '   END FORMULA; PROP ID:7696; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Hanger_Item.Formula_Sort_Order_1_Dbg_Grouping", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
