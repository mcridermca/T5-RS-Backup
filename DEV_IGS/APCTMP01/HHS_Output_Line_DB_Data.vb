...
'$ GenerateDate: 07/12/2025 19:19:17
    ...
    InitPart("HHS_Output_Line_DB_Data", <a><![CDATA[HHS Output Line DB Data]]></a>.Value, 338, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "07/08/2025 17:40:42")
    AddProperty("9507", "Component_Type", <a><![CDATA[Component Type]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 5:40:42 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Component_Type", "9087", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 5:40:42 PM", "", "In Development",  0,15179)
        End If
            If Incontext("-1", ctx) Then
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9087; TYPE:PF
      result = ""
      '   END FORMULA; PROP ID:9087; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " HHS_Output_Line_DB_Data.Formula_Component_Type", ex.Message)
