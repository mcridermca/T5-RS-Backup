...
'$ GenerateDate: 07/12/2025 13:20:28
    ...
    Private this as APC_Scan_Config = me
    ...
    ctx = ContextId
        ...
        InitSubpart("Scan_Configurations", 258, "", "", "Y", 0, "-1", "", "GLOBAL\H601424", "7/11/2025 5:59:29 PM", "", "In Development", "N",0,707,706)
    ...
    #Region " Formulas "
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:258; TYPE:PN
      
      '   END FORMULA; SUB ID:258; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " APC_Scan_Config.Formula_Scan_Configurations_PARTNAMES", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:258; TYPE:QF
      result = 1
      '   END FORMULA; SUB ID:258; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " APC_Scan_Config.Formula_Scan_Configurations_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:258; TYPE:OP
      result = "APC_Scan_Configuration"
      '   END FORMULA; SUB ID:258; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " APC_Scan_Config.Formula_Scan_Configurations_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
