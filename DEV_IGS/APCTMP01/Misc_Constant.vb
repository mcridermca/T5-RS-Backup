...
'$ PartFamily: Misc_Constant
    ...
    Private this as Misc_Constant = me
    ...
    InitPart("Misc_Constant", <a><![CDATA[Misc_Constant]]></a>.Value, 405, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H617242", "07/10/2025 07:02:24")
    AddProperty("9578", "CAE_MEI_Misc_Constants_ID", <a><![CDATA[CAE_MEI_Misc_Constants_ID]]></a>.Value, "Primary key for Misc Constants DB", "Long","","Mech Install Metrics","FD", 9999, "", 0,0, "", "", "GLOBAL\H617242", "7/10/2025 7:02:24 AM")
    AddProperty("8355", "Misc_Description", <a><![CDATA[Misc_Description]]></a>.Value, "Miscellaneous constants DB table column", "String","","Mech Install Metrics","FD", 9999, "", 0,0, "", "", "GLOBAL\H617242", "7/9/2025 6:57:12 AM")
    AddProperty("8356", "Misc_Factor", <a><![CDATA[Misc_Factor]]></a>.Value, "Miscellaneous constant factor", "Double","","Mech Install Metrics","FD", 9999, "", 0,0, "", "", "GLOBAL\H617242", "7/7/2025 6:10:29 AM")
    AddProperty("8354", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H617242", "7/7/2025 5:47:30 AM")
    
      AddValidValue("Misc_Factor")
    
      AddDBConstraint(8, "Misc_Constants_DbInfo", <a><![CDATA[Misc_Constants_DbInfo]]></a>.Value,"Mech Install Metrics", 9999)
    ...
    ctx = ContextId
          ...
          InitProperty("CAE_MEI_Misc_Constants_ID", "9158", "", "", "N", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H617242", "7/10/2025 7:00:25 AM", "", "In Development",  0,15918)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Misc_Description", "7940", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H617242", "7/9/2025 6:57:12 AM", "", "In Development",  0,15582)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Misc_Factor", "7941", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H617242", "7/7/2025 6:10:29 AM", "", "In Development",  0,12726)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitValidValue("Misc_Factor_ValidValues", "7941", "-1", 12727)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitDBConstraint("Misc_Constants_DbInfo", 8,"", "Y","", "", "CAE_MEI_Misc_Constants")
        
          InitDBproperty("Misc_Constants_DbInfo", "Misc_Description",8, "Misc_Description", "CAE_MEI_Misc_Constants")
        
          InitDBproperty("Misc_Constants_DbInfo", "Misc_Factor",8, "Factor", "CAE_MEI_Misc_Constants")
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9158; TYPE:PF
      Result = Me.Parent.ValidValues("Misc_Constants_Row_DBKeys")(Me.SubpartID-1)
      '   END FORMULA; PROP ID:9158; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Misc_Constant.Formula_CAE_MEI_Misc_Constants_ID", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:7940; TYPE:PF
      Result = "80/20 Guards"
      '   END FORMULA; PROP ID:7940; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Misc_Constant.Formula_Misc_Description", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:7941; TYPE:PF
      result = 0.0
      '   END FORMULA; PROP ID:7941; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Misc_Constant.Formula_Misc_Factor", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:7941; TYPE:VV
      ...
      '   END FORMULA; PROP ID:7941; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Misc_Constant.Formula_Misc_Factor_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
    ...
    Dim strSelectStmt As String = ""
      ...
      strSelectStmt = ""
      End If
      ObjectManager.LogError("Application: " + Me.Application + " Misc_Constant.GetRecordset", strError)
      If ObjectManager.StopOnErrors Then Stop
      End Try
