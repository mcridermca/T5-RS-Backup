...
'$ GenerateDate: 07/12/2025 19:19:17
    ...
    InitPart("sm_HHS_Group_Calculator", <a><![CDATA[sm HHS Group Calculator]]></a>.Value, 340, "APCTMP01",  "N", "N", False, False, "In Development", "", "Individual Header Hanger Calculator Subscription Master", "", "", "",  "GLOBAL\H601424", "07/11/2025 12:09:32")
    AddProperty("2389", "Component_Item_Keys", <a><![CDATA[Component Item Keys]]></a>.Value, "DBLookup Keys for SubPart Components", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/10/2025 7:56:51 PM")
    ...
    AddProperty("9770", "Sway_Bracing_Keys", <a><![CDATA[Sway_Bracing_Keys]]></a>.Value, "DBLookup Keys for SubPart Sway Bracing", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 12:09:32 PM")
    ...
    AddProperty("2237", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/22/2025 5:24:27 PM")
      ...
      oSubpart = AddSubpart(316,"Sway_Bracing_Items", <a><![CDATA[Sway_Bracing_Items]]></a>.Value, "FD", "", "General", 9999, "", "GLOBAL\H601424", "7/10/2025 3:02:37 AM")
      ...
      oConnection = AddConnection("My_HHS_Items", <a><![CDATA[My_HHS_Items]]></a>.Value, "HHS Items Specific To Me", "142", "OM", 0, "","General", 9999, "", "GLOBAL\H601424", "7/10/2025 5:04:53 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Component_Item_Keys", "2035", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/10/2025 7:56:51 PM", "DBLookup Keys for SubPart Components", "In Development",  0,3344)
        End If
            If Incontext("-1", ctx) Then
        ...
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sway_Bracing_Keys", "9345", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 12:09:23 PM", "DBLookup Keys for SubPart Hangers", "In Development",  0,15880)
        End If
            If Incontext("-1", ctx) Then
    ...
    ctx = ContextId
        ...
        InitValidValue("Component_Item_Keys_ValidValues", "2035", "-1", 16250)
        End If
            If Incontext("-1", ctx) Then
        ...
        InitValidValue("Sway_Bracing_Keys_ValidValues", "9345", "-1", 16384)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitSubpart("Sway_Bracing_Items", 243, "", "", "Y", 0, "-1", "", "GLOBAL\H601424", "7/10/2025 3:02:37 AM", "", "In Development", "N",0,668,682)
    ...
    ctx = ContextId
        ...
        InitConnection("My_HHS_Items", "122", "","", "Y", 0, "-1", "", "GLOBAL\H601424", "7/10/2025 5:04:53 PM", "", "In Development", "Y",230)
    ...
    #Region " Formulas "
      ...
      Try
      ctx = this
        '   BEGIN FORMULA; CON ID:122; TYPE:PF
...
For Each p As part In Me.Parent.My_HHS_Items
	...
	End If
Next P
        '   END FORMULA; CON ID:122; TYPE:PF
...
End If
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9345; TYPE:PF
      Result = 0
If Me.Valid Then
	Result = Me.ValidValues("Sway_Bracing_Keys").Count
End If
      '   END FORMULA; PROP ID:9345; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_HHS_Group_Calculator.Formula_Sway_Bracing_Keys", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9345; TYPE:VV
      Result = Nothing
...
End If
      '   END FORMULA; PROP ID:9345; TYPE:VV
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_HHS_Group_Calculator.Formula_Sway_Bracing_Keys_ValidValues", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Try
      ctx = this
      '   BEGIN FORMULA; SUB ID:243; TYPE:PN
      
      '   END FORMULA; SUB ID:243; TYPE:PN
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_HHS_Group_Calculator.Formula_Sway_Bracing_Items_PARTNAMES", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:243; TYPE:QF
      Result = Me.Sway_Bracing_Keys
      '   END FORMULA; SUB ID:243; TYPE:QF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_HHS_Group_Calculator.Formula_Sway_Bracing_Items_QUANTITY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; SUB ID:243; TYPE:OP
      result = "HHS_Sway_Bracing"
      '   END FORMULA; SUB ID:243; TYPE:OP
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_HHS_Group_Calculator.Formula_Sway_Bracing_Items_OPTIMALPARTFAMILY", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
