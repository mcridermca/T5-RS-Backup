...
'$ GenerateDate: 07/12/2025 13:20:28
    ...
    Private this as Excel_Reader_Test = me
    ...
    #Region " Properties, Subparts, Connections "
          ...
          Public Property [Excel_Output]() As String
      Get
      Return Properties("Excel_Output").Value
      End Get
      Set(ByVal Value As String)
      Properties("Excel_Output").CalculatedValue = Value
      End Set
      End Property
    ...
    InitPart("Excel_Reader_Test", <a><![CDATA[Exce lReader Test]]></a>.Value, 366, "APCTMP01",  "", "", True, True, "In Development", "", "", "", "", "",  "GLOBAL\H602502", "06/13/2025 12:44:33")
    AddProperty("2736", "Excel_Output", <a><![CDATA[Excel Output]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H602502", "6/13/2025 12:44:33 PM")
    AddProperty("2735", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "6/9/2025 4:20:30 PM")
    ...
    End Sub
        ...
        oProcessStep = AddProcessStep(52, "Step 1", "This process step was created automatically by RuleStream.", 1, 41, 1, 1, 50, 50)
        oProcessStep.AddPath("Excel_Reader_Test")
        oProcessStep.AddFilter(1, 366, "General", 1, "Excel_Output", 1)
    ...
    ctx = ContextId
          ...
          InitProperty("Excel_Output", "2370", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H602502", "6/13/2025 12:44:33 PM", "", "In Development",  0,4288)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Try
      '   BEGIN FORMULA; PROC ID:52; TYPE:ST
      result = STATUS_ENABLED
      '   END FORMULA; PROC ID:52; TYPE:ST
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Excel_Reader_Test.Process_DefaultProcess_Step_1_STATUS", ex.Message)
      ...
      Dim Result as String = ""
      Try
      '   BEGIN FORMULA; PROC ID:52; TYPE:CO
      result = ""
      '   END FORMULA; PROC ID:52; TYPE:CO
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Excel_Reader_Test.Process_DefaultProcess_Step_1_COMMENT", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
          ...
          '   Changes to this procedure may only be made within formula comment blocks.
          '*****************************************************************************
          Public Function Formula_Excel_Output() As String
      ...
      Try
      ctx = this
      If Me.Properties("Excel_Output").GetDebugState(Rulestream.Kernel.PropertySF.FormulaDebugTypes.VALUE_FORMULA) Then
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:2370; TYPE:PF
      'Dim wbXL As ClosedXML.Excel.IXLWorkbook = New ClosedXML.Excel.XLWorkbook("\\HIC044413\RSShared\IGS\MasterDocs\CAE-216-FM Engineering Quote Sheet_RS.xlsx")

' For Each wsXL As ClosedXML.Excel.IXLWorksheet In wbXL.Worksheets
' Result &= wsXL.Name & ":"
...
Result = ""  '''Causing compiling issues - TB 13/6/25
      '   END FORMULA; PROP ID:2370; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " Excel_Reader_Test.Formula_Excel_Output", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_Excel_Output_HIDE_CALCULATED_VALUE() as Boolean
      Return False
      End Function
      ...
      '   Changes to this procedure may only be made within formula comment blocks.
      '*****************************************************************************
      Public Function Formula_Excel_Output_USERCHANGE() as Boolean
      Return False
      End Function
