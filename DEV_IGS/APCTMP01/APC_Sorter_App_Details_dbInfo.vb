...
'$ GenerateDate: 07/19/2025 14:07:22
    ...
    InitPart("APC_Sorter_App_Details_dbInfo", <a><![CDATA[APC Sorter App Details dbInfo]]></a>.Value, 446, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "07/19/2025 14:06:34")
    AddProperty("10866", "Gap_Min_IN", <a><![CDATA[Gap Min IN]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 2:06:34 PM")
    AddProperty("10865", "Sorter_Type", <a><![CDATA[Sorter Type]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 2:06:15 PM")
    AddProperty("10863", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 1:58:22 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Gap_Min_IN", "10420", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/19/2025 2:06:34 PM", "", "In Development",  0,19504)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sorter_Type", "10419", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/19/2025 2:06:15 PM", "", "In Development",  0,19502)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:10420; TYPE:PF
      result = 0.0
      '   END FORMULA; PROP ID:10420; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " APC_Sorter_App_Details_dbInfo.Formula_Gap_Min_IN", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:10419; TYPE:PF
      result = ""
      '   END FORMULA; PROP ID:10419; TYPE:PF
      Catch ex As Exception
