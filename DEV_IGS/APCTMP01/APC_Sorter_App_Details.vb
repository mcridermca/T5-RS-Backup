...
'$ GenerateDate: 07/19/2025 14:07:22
    ...
    InitPart("APC_Sorter_App_Details", <a><![CDATA[APC Sorter App Details]]></a>.Value, 445, "APCTMP01",  "N", "N", False, False, "In Development", "", "", "", "", "",  "GLOBAL\H601424", "07/19/2025 14:06:55")
    AddProperty("10864", "Gap_Min_IN", <a><![CDATA[Gap Min IN]]></a>.Value, "", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 2:06:55 PM")
    AddProperty("10862", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/19/2025 1:58:22 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Gap_Min_IN", "10418", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/19/2025 2:06:55 PM", "", "In Development",  0,19497)
        End If
    End Sub
    ...
    #Region " Formulas "
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:10418; TYPE:PF
      result = 0.0
...
End If
      '   END FORMULA; PROP ID:10418; TYPE:PF
