...
'$ GenerateDate: 07/12/2025 13:20:28
    ...
    InitPart("sm_Generic_BOM_Item", <a><![CDATA[sm Generic BOM Item]]></a>.Value, 357, "APCTMP01",  "N", "N", False, False, "In Development", "", "Generic BOM Rollup Item Subscription Master", "", "", "",  "GLOBAL\H601424", "07/11/2025 02:22:58")
    AddProperty("9508", "Component_Type", <a><![CDATA[Component Type]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 5:47:36 PM")
    AddProperty("2472", "ExtdCost", <a><![CDATA[Extended Cost]]></a>.Value, "Extended Cost", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 2:22:58 AM")
    AddProperty("2470", "Item_Description", <a><![CDATA[Item Description]]></a>.Value, "Item Description", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 8:42:58 PM")
    AddProperty("9499", "Location", <a><![CDATA[Location]]></a>.Value, "", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/8/2025 5:00:43 PM")
    AddProperty("2468", "Part_Number_ERP", <a><![CDATA[Part Number ERP]]></a>.Value, "ERP Part Number", "String","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 9:10:36 PM")
    AddProperty("2469", "Qty", <a><![CDATA[Qty]]></a>.Value, "Qty", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "7/11/2025 2:11:30 AM")
    AddProperty("2473", "Sort_Order_1", <a><![CDATA[Sort Order 1]]></a>.Value, "Sorting Order (Overridable)", "Long","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 8:42:59 PM")
    AddProperty("2471", "UnitCost", <a><![CDATA[UnitCost]]></a>.Value, "Unit Cost", "Double","","General","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 8:42:58 PM")
    AddProperty("2466", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/30/2025 5:30:30 PM")
    
      oConnection = AddConnection("My_Parts", <a><![CDATA[My Parts]]></a>.Value, "Collection of Items with same part number", "104", "OM", 0, "","General", 9999, "", "GLOBAL\H601424", "7/10/2025 5:56:01 PM")
    ...
    ctx = ContextId
          ...
          InitProperty("Component_Type", "9088", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 5:47:36 PM", "", "In Development",  0,15182)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("ExtdCost", "2114", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 2:22:58 AM", "Extended Cost", "In Development",  0,16334)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Item_Description", "2112", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/30/2025 8:42:58 PM", "Item Description", "In Development",  0,3398)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Location", "9079", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/8/2025 5:00:43 PM", "", "In Development",  0,15168)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Part_Number_ERP", "2110", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/30/2025 9:10:36 PM", "ERP Part Number", "In Development",  0,3442)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Qty", "2111", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/11/2025 2:11:30 AM", "Qty", "In Development",  0,16331)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Sort_Order_1", "2115", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/30/2025 8:42:59 PM", "Sorting Order (Overridable)", "In Development",  0,3406)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("UnitCost", "2113", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/30/2025 8:42:58 PM", "Unit Cost", "In Development",  0,3402)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitConnection("My_Parts", "84", "","", "Y", 0, "-1", "", "GLOBAL\H601424", "7/10/2025 5:56:01 PM", "Collection of Items with same part number", "In Development", "Y",244)
...
Next p1
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9088; TYPE:PF
      Dim MyPropertyName = Me.CurrentProperty.Name
Result = My_Parts(1).Properties(MyPropertyName).DisplayValue
      '   END FORMULA; PROP ID:9088; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_Generic_BOM_Item.Formula_Component_Type", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
Result = My_Parts(1).Item_Description
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:9079; TYPE:PF
      Dim MyPropertyName = Me.CurrentProperty.Name
Result = My_Parts(1).Properties(MyPropertyName).DisplayValue
      '   END FORMULA; PROP ID:9079; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " sm_Generic_BOM_Item.Formula_Location", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
