...
'$ PartFamily: OCT_Accessory
'$ GenerateDate: 07/07/2025 15:32:15
    ...
    Private this as OCT_Accessory = me
    ...
    InitPart("OCT_Accessory", <a><![CDATA[OCT_Accessory]]></a>.Value, 33, "OCTTMP01",  "N", "N", False, False, "In Development", "", "Oracle Transfer Accessory Object", "", "", "",  "GLOBAL\H601424", "07/07/2025 15:32:09")
    AddProperty("2147", "Debug_Mode", <a><![CDATA[Debug_Mode]]></a>.Value, "True = Debug On / False = Debug Off", "Boolean","","Debugging","FD", 9999, "", 0,0, "", "", "GLOBAL\H601424", "4/16/2025 1:52:00 AM")
    AddProperty("1954", "JSONObjectName", <a><![CDATA[JSONObjectName]]></a>.Value, "JSON Export Object Name", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    AddProperty("1955", "JSONObjectType", <a><![CDATA[JSONObjectType]]></a>.Value, "JSON Export Object Type", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    AddProperty("2148", "JSONObjectValue", <a><![CDATA[JSONObjectValue]]></a>.Value, "JSON Export Object Value", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "7/7/2025 3:32:09 PM")
    AddProperty("2196", "Name_RSVD", <a><![CDATA[Name Of Accessory]]></a>.Value, "", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/17/2025 11:11:33 PM")
    AddProperty("1959", "Quantity", <a><![CDATA[Quantity]]></a>.Value, "Quantity", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    AddProperty("1956", "XMLObjectName", <a><![CDATA[XMLObjectName]]></a>.Value, "XML Export Object Name", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    AddProperty("1957", "XMLObjectType", <a><![CDATA[XMLObjectType]]></a>.Value, "XML Export Object Type", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    AddProperty("2160", "XMLObjectValue", <a><![CDATA[XMLObjectValue]]></a>.Value, "XML Export Object Value", "String","","Oracle Config XML","FD", 9999, "", 0,0, "Oracle Configurator Transfer", "", "GLOBAL\H601424", "7/7/2025 1:33:29 PM")
    AddProperty("449", "PartNumber", <a><![CDATA[Part Number]]></a>.Value, "", "String","N","System","MN", 9999, "", 0,0, "", "", "GLOBAL\H601424", "3/20/2025 4:34:59 PM")
    
      oConnection = AddConnection("MySource", <a><![CDATA[My Source Part Family]]></a>.Value, "Connection to the Value Provider Part Family Instance", "56", "OO", 0, "","Oracle Config XML", 9999, "Oracle Configurator Transfer", "GLOBAL\H601424", "4/15/2025 1:55:23 AM")
    ...
    ctx = ContextId
          ...
          InitProperty("Debug_Mode", "1815", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/16/2025 1:52:00 AM", "True = Debug On / False = Debug Off", "In Development",  0,2228)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("JSONObjectName", "1631", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "JSON Export Object Name", "In Development",  0,1737)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("JSONObjectType", "1632", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "JSON Export Object Type", "In Development",  0,1738)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("JSONObjectValue", "1816", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/7/2025 3:31:56 PM", "JSON Export Object Value", "In Development",  0,13679)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Name_RSVD", "1864", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/17/2025 11:11:33 PM", "", "In Development",  0,2469)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("Quantity", "1636", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "Quantity", "In Development",  0,2230)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("XMLObjectName", "1633", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "XML Export Object Name", "In Development",  0,2190)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("XMLObjectType", "1634", "", "", "Y", "N","N", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "XML Export Object Type", "In Development",  0,1740)
        End If
            If Incontext("-1", ctx) Then
          InitProperty("XMLObjectValue", "1828", "", "", "Y", "","", 0, "-1", 0, "", "N","0",  "GLOBAL\H601424", "7/7/2025 1:33:29 PM", "XML Export Object Value", "In Development",  0,2231)
        End If
    End Sub
    ...
    ctx = ContextId
        ...
        InitConnection("MySource", "36", "N","N", "N", 0, "-1", "", "GLOBAL\H601424", "4/15/2025 1:55:23 AM", "Connection to the Value Provider Part Family Instance", "In Development", "Y",53)
...
End If
      ...
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_MySource_PARTS", ex.Message)
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1815; TYPE:PF
      Result = False
If Not Me.Parent Is Nothing AndAlso Me.Parent.Properties.ContainsKey("Debug_Mode") Then
		Result = Me.Parent.Debug_Mode
End If
      '   END FORMULA; PROP ID:1815; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_Debug_Mode", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_JSONObjectName", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_JSONObjectType", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1816; TYPE:PF
      Dim Prop As PropertySF = Me.CurrentProperty
Result = Custom.GetPFJSONRepresentation(Prop)
      '   END FORMULA; PROP ID:1816; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_JSONObjectValue", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1864; TYPE:PF
      Result = ""
...
End If
      '   END FORMULA; PROP ID:1864; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_Name_RSVD", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
...
End If
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_Quantity", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_XMLObjectName", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_XMLObjectType", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
      ...
      Stop
      End If
      '   BEGIN FORMULA; PROP ID:1828; TYPE:PF
      Dim Prop As PropertySF = Me.CurrentProperty
Result = Custom.GetPFXMLRepresentation(Prop)
      '   END FORMULA; PROP ID:1828; TYPE:PF
      Catch ex As Exception
      ObjectManager.LogError("Application: " + Me.Application + " OCT_Accessory.Formula_XMLObjectValue", ex.Message)
      If ObjectManager.StopOnErrors Then Stop
      End Try
      Return Result
      End Function
