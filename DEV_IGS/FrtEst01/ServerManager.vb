...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		...
		arr(8) = "419CAE_EHS350_DataCAE_EHS350_Data"
		arr(9) = "361CAE_Elec_Install_AppCAE_Elec_Install_App"
		arr(10) = "365CAE_Elec_Install_CP_CompsCAE Elec Install CP Comps"
		arr(11) = "381CAE_Elec_Install_MetricsCAE_Elec_Install_Metrics"
		arr(12) = "360CAE_Mech_Install_AppCAE Mech Install App"
		arr(13) = "384CAE_Mech_Install_Conveyor_HoursCAE Mech Install Conveyor Hours"
		arr(14) = "399CAE_Mech_Install_CP_CompCAE_Mech_Install_CP_Comp"
		arr(15) = "382CAE_Mech_Install_MetricsCAE_Mech_Install_Metrics"
		arr(16) = "410CAE_MEI_Package_Flow_RatesCAE_MEI_Package_Flow_Rates"
		arr(17) = "415CAE_MEI_Pallet_ConveyorCAE_MEI_Pallet_Conveyor"
		arr(18) = "396CAE_Power_Feed_Control_PanelCAE_Power_Feed_Control_Panel"
		arr(19) = "395CAE_Power_FeedsCAE_Power_Feeds"
		...
		arr(26) = "307Connection_Path_ListConnection_Path_List"
		arr(27) = "142CPM_CORA_Data_MockCPM_CORA_Data_Mock"
		arr(28) = "144CPM_DBDetails_CORACPM_DBDetails_CORA"
		arr(29) = "22Freight_Estimate_HeadFreight_Estimate_Head"
		arr(30) = "21Freight_Estimate_ItemFreight_Estimate_Item"
		arr(31) = "35Freight_Estimate_ShipFrom_SumFreight_Estimate_ShipFrom_Sum"
		arr(32) = "308GEN_Connection_Path_ListGEN_Connection_Path_List"
		arr(33) = "404Hanger_TypeHanger_Type"
		arr(34) = "18IGS_Freight_AppIGS_Freight_App"
		arr(35) = "302IGS_Opportunity_DataIGS_Opportunity_Data"
		arr(36) = "377IGS_Tool_Instance_MgrIGS_Tool_Instance_Mgr"
		arr(37) = "405Misc_ConstantMisc_Constant"
		arr(38) = "24Salesforce_Header_DemoSalesforce_Header_Demo"
		arr(39) = "143SFD_Salesforce_Data_MockSFD_Salesforce_Data_Mock"
		arr(40) = "163SFD_Salesforce_PRD_Header_MockSFD_Salesforce_PRD_Header_Mock"
		arr(41) = "164SFD_Salesforce_PRD_Product_ItemSFD_Salesforce_PRD_Product_Item"
		arr(42) = "371SFD_sm_PRD_Base_ItemSubMst PRD Base Item"
