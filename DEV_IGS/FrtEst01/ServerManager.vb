...
#Region " IRsApplicationManager Interface Implementation "
	...
	Public Function GetClassAssemblyName(ByVal strName as String) As String Implements RuleStream.IRsApplicationManager.GetClassAssemblyName
		Select Case strName.ToLower
			...
			Case "connection_path_list" : Return "FrtEst01"
			...
			Case "salesforce_header_demo" : Return "FrtEst01"
...
End Function
	...
	Public Function GetPartFamilies() As String() Implements RuleStream.IRsApplicationManager.GetPartFamilies
		Dim arr(67) as String 
		arr(0) = "122APC_InductionAPC_Induction"
		arr(1) = "417APC_Scan_ConfigurationAPC_Scan_Configuration"
		arr(2) = "418APC_Scan_Panel_ConfigurationAPC_Scan_Panel_Configuration"
		arr(3) = "119APC_SetupAPC_Setup"
		arr(4) = "120APC_SortationAPC_Sortation"
		arr(5) = "392CAE_Air_Piping_Control_PanelCAE_Air_Piping_Control_Panel"
		arr(6) = "411CAE_App_CalcCAE_App_Calc"
		arr(7) = "416CAE_App_Calc_Print_And_ApplyCAE_App_Calc_Print_And_Apply"
		arr(8) = "422CAE_App_Calc_Print_And_Apply_Theoretical_MaxCAE_App_Calc_Print_And_Apply_Theoretical_Max"
		arr(9) = "409CAE_ChutesCAE_Chutes"
		arr(10) = "387CAE_Control_Panels_Structures_PlatformsCAE_Control_Panels_Structures_Platforms"
		arr(11) = "389CAE_Conveyor_CostingCAE_Conveyor_Costing"
		arr(12) = "394CAE_Conveyor_Costing_ElecCAE_Conveyor_Costing_Elec"
		arr(13) = "393CAE_Conveyor_Installs_ElecCAE_Conveyor_Installs_Elec"
		arr(14) = "419CAE_EHS350_DataCAE_EHS350_Data"
		arr(15) = "361CAE_Elec_Install_AppCAE_Elec_Install_App"
		arr(16) = "365CAE_Elec_Install_CP_CompsCAE Elec Install CP Comps"
		arr(17) = "381CAE_Elec_Install_MetricsCAE_Elec_Install_Metrics"
		arr(18) = "360CAE_Mech_Install_AppCAE Mech Install App"
		arr(19) = "384CAE_Mech_Install_Conveyor_HoursCAE Mech Install Conveyor Hours"
		arr(20) = "399CAE_Mech_Install_CP_CompCAE_Mech_Install_CP_Comp"
		arr(21) = "382CAE_Mech_Install_MetricsCAE_Mech_Install_Metrics"
		arr(22) = "410CAE_MEI_Package_Flow_RatesCAE_MEI_Package_Flow_Rates"
		arr(23) = "415CAE_MEI_Pallet_ConveyorCAE_MEI_Pallet_Conveyor"
		arr(24) = "427CAE_Misc_ConstantCAE_Misc_Constant"
		arr(25) = "396CAE_Power_Feed_Control_PanelCAE_Power_Feed_Control_Panel"
		arr(26) = "395CAE_Power_FeedsCAE_Power_Feeds"
		arr(27) = "397CAE_Shuttle_ElecCAE_Shuttle_Elec"
		arr(28) = "398CAE_Shuttle_MechCAE_Shuttle_Mech"
		arr(29) = "385CAE_Structures_PlatformCAE_Structures_Platform"
		arr(30) = "386CAE_Structures_PlatformsCAE_Structures_Platforms"
		arr(31) = "402CAE_TTCB_Costing_ElecCAE_TTCB_Costing_Elec"
		arr(32) = "401CAE_TTCB_Costing_MechCAE_TTCB_Costing_Mech"
		arr(33) = "307Connection_Path_ListConnection_Path_List"
		arr(34) = "142CPM_CORA_Data_MockCPM_CORA_Data_Mock"
		arr(35) = "144CPM_DBDetails_CORACPM_DBDetails_CORA"
		arr(36) = "22Freight_Estimate_HeadFreight_Estimate_Head"
		arr(37) = "21Freight_Estimate_ItemFreight_Estimate_Item"
		arr(38) = "35Freight_Estimate_ShipFrom_SumFreight_Estimate_ShipFrom_Sum"
		arr(39) = "308GEN_Connection_Path_ListGEN_Connection_Path_List"
		arr(40) = "358HHS_BOM_ItemHHS BOM Item"
		arr(41) = "407HHS_BOM_Report_HeaderHHS_BOM_Report_Header"
		arr(42) = "408HHS_BOM_Report_LineHHS_BOM_Report_Line"
		arr(43) = "353HHS_Component_ItemHHS Component Item"
		arr(44) = "354HHS_Component_Item_DB_DataHHS_Component_Item_DB_Data"
		arr(45) = "335HHS_DWGXLSX_Import_LineHHS Import Line"
		arr(46) = "334HHS_DWGXLSX_ImporterHeader Hanger DWG Excel Importer"
		arr(47) = "339HHS_Grouping_Matrix_ControllerHHS Grouping Matrix Controller"
		arr(48) = "356HHS_Hanger_ItemHHS_Hanger_Item"
		arr(49) = "355HHS_Hanger_Item_DB_DataHHS Hanger Item DB Data"
		arr(50) = "333HHS_HeaderHanger_CalcHeader Hanger Calculator"
		arr(51) = "336HHS_Output_HeaderHHS Output Header"
		arr(52) = "337HHS_Output_LineHHS Output Line"
		arr(53) = "338HHS_Output_Line_DB_DataHHS Output Line DB Data"
		arr(54) = "413HHS_Sway_BracingHHS_Sway_Bracing"
		arr(55) = "414HHS_Sway_Bracing_DB_DataHHS_Sway_Bracing_DB_Data"
		arr(56) = "18IGS_Freight_AppIGS_Freight_App"
		arr(57) = "302IGS_Opportunity_DataIGS_Opportunity_Data"
		arr(58) = "377IGS_Tool_Instance_MgrIGS_Tool_Instance_Mgr"
		arr(59) = "425PRD_Output_Test_01PRD_Output_Test_01"
		arr(60) = "426PRD_Output_Test_01_LinePRD_Output_Test_01_Line"
		arr(61) = "24Salesforce_Header_DemoSalesforce_Header_Demo"
		arr(62) = "143SFD_Salesforce_Data_MockSFD_Salesforce_Data_Mock"
		arr(63) = "163SFD_Salesforce_PRD_Header_MockSFD_Salesforce_PRD_Header_Mock"
		arr(64) = "164SFD_Salesforce_PRD_Product_ItemSFD_Salesforce_PRD_Product_Item"
		arr(65) = "371SFD_sm_PRD_Base_ItemSubMst PRD Base Item"
		arr(66) = "357sm_Generic_BOM_Itemsm Generic BOM Item"
		arr(67) = "340sm_HHS_Group_Calculatorsm HHS Group Calculator"
	...
	Public Function GetProcesses() As String() Implements RuleStream.IRsApplicationManager.GetProcesses
		Dim arr(0) as String
		arr(0) = "4DefaultProcess1811111DD00000"
		Return arr
	...
	Public Function GetTopLevelParts() As String() Implements RuleStream.IRsApplicationManager.GetTopLevelParts
		Dim arr(0) as String
		arr(0) = "18IGS_Freight_App53FrtEst01IGS_Freight_App"
		Return arr
